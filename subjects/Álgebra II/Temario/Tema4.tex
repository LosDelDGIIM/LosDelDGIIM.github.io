...
\begin{teo}[Jordan-Holder]
    ...
    \begin{proof}
        ...
        \begin{equation*}
            G_k/G_{k+1} \cong \overline{G}_K/\overline{G}_{k+1} \qquad \forall k \in \{0,\ldots,r-1\}
        \end{equation*}
...
\begin{prop}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            G = G_0 \rhd G_1 \rhd \ldots \rhd G_r = \{1\} 
        \end{equation*}
        una serie de composición de $G$, tendremos entonces que sus factores son de composición, luego grupos simples. 
    \end{proof}
\end{prop}~\\
