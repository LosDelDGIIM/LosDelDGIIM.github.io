...
\begin{observacion}
    ...
    \begin{itemize}
        ...
        \item En la demostración $iv)\Longrightarrow i)$ en realidad no se usó que $G$ tuiera una serie normal con factores cíclicos, sino que las hipótesis puede relajarse a que $G$ tenga una serie normal con factores abelianos. Además, en esta tampoco usamos que $G$ era finito.
    \end{itemize}
\end{observacion}
