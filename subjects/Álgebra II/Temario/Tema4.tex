...
\begin{ejemplo} % Ejercicio 5 de la relacion
    ...
    \begin{itemize}
        \item En $S_3$, recordamos que el retículo de subgrupos que teníamos era:
            ...
            \end{figure}
            Como $A_3 = \langle (1\ 2\ 3) \rangle \lhd S_3$ (por tener índice 2) y ningún otro subgrupo de $S_3$ es normal salvo el trivial (compruébese), la única serie de composición de $S_3$ es:
            \begin{equation*}
                S_3 \rhd A_3 \rhd \{1\}
            \end{equation*}
        \item En $D_4$:
...
\begin{prop}\label{prop:homomorfismo_resoluble}
...
\begin{lema}
    ...
    % Puede eliminarse si demuestras iii) haciendo uso de: https://grok.com/share/c2hhcmQtMg%3D%3D_ee59be3f-f69b-4a20-937e-903f7ebe9488
\end{lema}
