...
% // TODO: Arturo. Añadiria una observacion de que <S> es igual al generado por todos los inversos de S. Sirve mucho para hallar el de Hasse de Z12, x ejemplo
...
\begin{prop}
    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            %     \end{multline*}
            %     % // TODO: Arreglar. Está mal. Te lo dije el 18/03 a las 15.25
    ...
    \begin{proof} Veamos cada una de ellas:
        \begin{enumerate}
            ...
            \item[$ii)$] Sean $f:xH\longrightarrow H$, $g:H\longrightarrow Hx$ dadas por:
                ...
                \end{align*}
                Es fácil comprobar que $f$ y $g$ son biyectivas, por lo que $xH$ es biyectivo con $H$ y $H$ es biyectivo con $Hx$. Basta considerar $g\circ f$ para obtener una biyección de $xH$ con $Hx$. % // TODO: Comprobar f y g biyectivas
            \item[$iii)$] Sea $f:G/\prescript{}{H}{\sim}\longrightarrow G/\sim_H$ dada por:
                ...
                \end{equation*}
                Por lo que $Hx^{-1} = Hy^{-1}$, luego $f$ está bien definida. Finalmente, es fácil ver que $f$ es biyectiva. % // TODO: Hacer
        \end{enumerate}
    \end{proof}
\end{prop}
...
\begin{ejemplo}
    Como ejemplos de índices de grupos en subgrupos, recuperamos las figuras % // TODO: Referenciar las figuras del ejemplo de ayer.
    \begin{enumerate}
...
\begin{teo}[de Lagrange] % // TODO: Candidato a caer en examenes
...
Sin embargo, si $G$ es infinito, podremos tener subgrupos de índice infinito o finito. 
...
% // TODO: Poner la otra implicación en la proposición del T1.
\begin{prop}
