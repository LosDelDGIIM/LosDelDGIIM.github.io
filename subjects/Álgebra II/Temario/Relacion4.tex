...
\begin{ejercicio}
    ...
    Construimos ahora automorfismos de $\bb{Z}_2\times \bb{Z}_2$. Sabemos que $|\bb{Z}_2\times \bb{Z}_2|=4$.
    % // TODO: hacer
\end{ejercicio}
...
\begin{ejercicio}
    ...
    Sea $f:A\to K$ y $g:B\to H$ los isomorfismos. Definimos la aplicación $h:A\times B\to K\times H$ como:
    \begin{equation*}
        h(a,b) = (f(a),g(b))\qquad \forall (a,b)\in A\times B
    \end{equation*}
...
\begin{ejercicio}
    ...
    \begin{equation*}
        \dfrac{G}{\ker(f)}\cong \dfrac{G}{\{1\}} \cong G
    \end{equation*}
...
\begin{ejercicio}
    ...
    Por el Segundo Teorema de Isomorfía, tenemos que $H\cap K\lhd H,K$. Veamos ahora que $H\cap K\lhd G$. Para ello, tomamos $g\in G$ y $x\in H\cap K$. Como $G=HK$, tenemos que $g=hk$ con $h\in H$ y $k\in K$. Entonces:
    \begin{align*}
...
\begin{ejercicio}
    ...
    \begin{description}
        ...
        Veamos ahora que es sobreyectiva. Dado $g\in G$, tomamos $x=f(g)\in Im(f)$ e $y=f(g^{-1})g$. Veamos en primer lugar que $y\in \ker(f)$:
        \begin{align*}
...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Sea $x,y\in C_G(S)$. Entonces $xs=sx$ y $ys=sy$. Entonces:
                \begin{align*}
                    (xy)s &= x(ys) = x(sy) = (xs)y = (sx)y = s(xy)
                \end{align*}
                Por tanto, es cerrado para el producto.
