...
\begin{equation*}
    |H| = |H\cap Z(G)| + \sum_{y\in H\setminus Z(G)} [G:C_G(y)]
\end{equation*}
...
Al siguiente Lema también le llaman Segundo Teorema de Sylow, aunque nos reservamos este nombre para el resultado que se demuestra a partir del Lema.
\begin{lema}
    ...
    \begin{proof} % // TODO: Recordarle que haga la demostración
        ...
        \begin{enumerate}
            \item[$i)$] Si llamamos $S = Syl_p(G) = \{P \mid P \text{\ es un\ } p-\text{subgrupo\ de Sylow de\ } G\}$, consideramos la acción por conjugación $G\times S\to S$ dada por:
                ...
                \end{equation*}
                De donde tenemos que $H\cap N_G(P) = H \cap P$. Usando la fórmula de la órbita: % // TODO: Poner esa formula de alguna forma para referenciarla
                \begin{equation*}
