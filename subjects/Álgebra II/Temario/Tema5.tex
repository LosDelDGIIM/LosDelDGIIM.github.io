...
\begin{notacion}
    ...
    \noindent
    Con esta notación, las propiedades que ha de cumplir una aplicación $ac:G\times X\to X$ para ser una acción son:
    \begin{enumerate}
...
\begin{equation*}
    Orb(h) = \{k\in G \mid \exists g\in G \text{\ con\ } gk = \prescript{g}{}{k} = h\} = G \qquad \forall h\in G
\end{equation*}
Ya que fijado $h\in G$ y dado $k\in G$, siempre podemos tomar $g = hk^{-1}\in G$ para tener que $\prescript{g}{}{k} = gk = h$.
\begin{align*}
...
\begin{equation*}
    Orb(h) = \{k\in G \mid \exists g\in G \text{\ con\ } gkg^{-1} = \prescript{g}{}{k} = h\} = 
\end{equation*}
...
Vemos finalmente los subgrups que quedan fijos mediante la acción:
\begin{multline*}
...
Al siguiente Lema también le llaman Segundo Teorema de Sylow, aunque nos reservamos este nombre para el resultado que se demustra a partir del Lema.
\begin{lema}
...
\begin{teo}[Segundo Teorema de Sylow]
    ...
    \end{enumerate}
    % \begin{proof} % // TODO: Recordarle que haga la demostración
    % \end{proof}
\end{teo}
                ...
                \item En $S_4$, $|S_4| = 24 = 2^3 \cdot 3$:
                    \begin{itemize}
                        \item Para los $2-$subgrupos:
                            ...
                            Por tanto, tenemos $n_2 = 3$, tenemos $3$ $2-$subgrupos de Sylow: $Q_1$, $Q_2$ y $Q_3$. El grupo de Klein $V$ es un $2-$subgrupo, y es normal en $S_4$. Por tanto, va a estar contenido en algún $Q_k$ ($k \in \{1,2,3\}$). Supongamos que $V<Q_1$. Como todos ellos son conjugados, $\exists \alpha,\beta\in S_4$ de forma que:
                            \begin{align*}
                        ...
                        \item Para el caso $n_3$:
                            \begin{equation*}
                                ...
                                \end{array}\right\} \Longrightarrow n_3 \in \{1,4\}
                            \end{equation*}
                            Serán los subgrupos de la forma:
                            \begin{equation*}
