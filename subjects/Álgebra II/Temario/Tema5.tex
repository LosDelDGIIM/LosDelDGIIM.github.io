...
\begin{prop} % // TODO: Ej 30 relacion 4
...
\noindent
Sea $G$ un gurpo, la acción por conjugación sobre subgrupos viene definida por $ac:G\times Subg(G)\to Subg(G)$ (está bien definida gracias a la Proposición~\ref{prop:xHx_subgrupo}):
Veamos que:
\begin{equation*}
    ...
    \begin{proof} % // TODO: Recordarle que haga la demostración
        ...
        \begin{enumerate}
            \item[$i)$] Si llamamos $S = Syl_p(G) = \{P \mid P \text{\ es un\ } p-\text{subgrupo\ de Sylow de\ } G\}$, consideramos la acción por conjugación $G\times S\to S$ dada por:
                ...
                \end{equation*}
                De donde tenemos que $N_G(P) = H \cap P$. Usando la fórmula de la órbita: % // TODO: Poner esa formula de alguna forma para referenciarla
                \begin{equation*}
