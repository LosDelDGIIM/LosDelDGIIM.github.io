    ...
    \begin{proof}
        ...
        \begin{description}
            ...
            \item [$iii)\Longrightarrow iv)$] Falta ver que $H\subseteq xHx^{-1}$. Para ello, si cogemos $x\in G$, en particular tendremos que $x^{-1}\in G$, con lo que (por hipótesis):
                ...
                \end{equation*}
            \item [$iv)\Longrightarrow i)$] Fijado $x\in G$:
                \begin{description}
...
\begin{ejemplo}
    Hemos caracterizado ya a los grupos normales, pero veamos que de verdad existen con ejemplos:
    \begin{enumerate}
        \item Dado un grupo $G$, los dos subgrupos impropios de $G$ siempre son subgrupos normales del mismo:
            \begin{itemize}
                ...
                \item Para el caso $H=G$:
                    ...
                    \end{equation*}
                    Y por la misma razón, también tenemso que $G\lhd G$.
            \end{itemize}
