...
\begin{teo}[Segundo Teorema de Isomorfía para grupos]\label{teo:2_isomorfia}
    ...
    \begin{proof}
        Como $K \lhd G$, tenemos que $xK=Kx$ para todo $x\in G$, en particular para $x\in H$, con lo que $HK = KH$, lo que nos dice que $HK < G$. Además, vemos que $K\lhd HK$. % Hacer.\\
    ...
    \begin{proof}
        ...
        \begin{enumerate}
            \item Sea $L<H\times K$, consideramos:
                ...
                \end{equation*}
            \item Basta ver que $\psi$ es sobreyectiva. % // TODO: HACER
        \end{enumerate}
    \end{proof}
\end{teo}
