...
\begin{ejercicio}\label{ej:6.17}
    ...
    \begin{enumerate}
        ...
        Sea ahora $G$ otro grupo de orden $p^2$ que no es isomorfo a los anteriores. Por el Teorema de Cauchy, existe $x\in G$ tal que $\ord(x)=p$. Sea también $y\in G\setminus \langle x\rangle$ otro elemento de $G$ (que es posible puesto que $|G|=p^2>p$). Consideramos:
        \begin{equation*}
            H=\langle x\rangle\qquad K=\langle y\rangle
        \end{equation*}
        \begin{itemize}
            \item Como $y\in G$, entonces $\ord(y)\in \{1,p,p^2\}$. Como $y\notin H$, tenemos que $\ord(y)\neq 1$. Como $G$ no es cíclico, tenemos que $\ord(y)\neq p^2$. Por tanto, $\ord(y)=p$.
            \item Como $\ord(x)=p$ y $\ord(y)=p$, supongamos que $\exists g\in \langle x\rangle\cap \langle y\rangle$, $g\neq 1$. Entonces, como todos los elementos distintos de $1$ de un grupo cíclico de orden primo son generadores, tenemos que:
            \begin{equation*}
                \langle g\rangle = \langle x\rangle = \langle y\rangle
            \end{equation*}
            Esto no obstante contradice la elección de $y\in G\setminus \langle x\rangle$. Por tanto, $\langle x\rangle\cap \langle y\rangle = \{1\}$.
            \item Como $G$ es abeliano, tenemos que $H,K\lhd G$.
            \item Veamos que $HK=G$. Por el Segundo Teorema de Isomorfía, tenemos que:
            \begin{equation*}
                \dfrac{H}{H\cap K} \cong \dfrac{HK}{K}
                \Longrightarrow 
                |HK| = \dfrac{|H|}{|H\cap K|}\cdot |K| = |H|\cdot |K| = p\cdot p = p^2
            \end{equation*}
            Por tanto, $HK<G$ y $|HK|=p^2=|G|$, luego $HK=G$.
        \end{itemize}

        Por la caracterización de producto directo interno, tenemos que:
        \begin{equation*}
            G\cong H\times K\cong C_p\times C_p
        \end{equation*}
        Por tanto, $G$ es isomorfo a $C_p\times C_p$, luego $G$ es isomorfo a uno de los grupos que hemos considerado antes.
