...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        Supongamos que $Im(\Phi)$ contiene una permutación impar. Entonces, existe $x\in G$ tal que $\veps(\Phi(x))=-1$. Por el apartado anterior, tenemos que $n=\ord(x)$ es par y $m=\dfrac{|G|}{n}$ es impar.
