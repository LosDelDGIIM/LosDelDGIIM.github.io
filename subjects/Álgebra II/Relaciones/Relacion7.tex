...
\begin{ejercicio}\label{ej:7.7}
    ...
    \begin{enumerate}
        ...
        Los divisores elementales son $\{1; 1; 4; 3\}$.
...
\begin{ejercicio}\label{ej:7.9}
    ...
    \begin{enumerate}
        ...
        Antes de trabajar con $H$, trabajamos con $K$. Veamos si su sistema de generadores forman una base:
        \begin{equation*}
            \begin{vmatrix}
                1 & 1 & -1 \\
                2 & 4 & 0 \\
        ...
        Por tanto, dichos tres elementos (vistos como vectores de $\bb{R}^3$) forman una base de $\bb{R}^3$ y, por tanto, forman una base de $K$. Por tanto, $K$ es un grupo abeliano de rango $3$ y deducimos que $K\cong \bb{Z}^3$. Como además $K<\bb{Z}^3$, podemos deducir que $K=\bb{Z}^3$.
        Por tanto, $H = \bb{Z}^3/K$ es isomorfo al grupo trivial $\{0\}$, que es abeliano de rango $0$.
        ...
        Como $G\cong H\cong G\cong \{0\}\cong G$, se tiene.
    \end{enumerate}
\end{ejercicio}
