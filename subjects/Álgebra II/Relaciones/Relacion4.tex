...
\begin{ejercicio}
    ...
    \Func{f}{N}{(N\cap H)\times (N\cap K)}{n=hk}{(h,k)}
...
\begin{ejercicio}~\label{ej:4.34}
    \begin{enumerate}
        ...
        \begin{description}
            \item[$\subset)$] Tenemos que $[S_n : A_n] = 2$, luego $A_n\lhd S_n$. Como además $S_n/A_n\cong \bb{Z}_2$ (abeliano), $[S_n,S_n]\subseteq A_n$.
