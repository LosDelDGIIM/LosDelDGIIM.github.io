    ...
    \begin{figure}
        ...
        \resizebox{1.1\textwidth}{!}{
            \begin{tikzpicture}[node distance=15em]
                ...
                \node[yshift=-1.5em, xshift=1.8em, purple] at(CP_Asociado) {(3,4)};
                \node[yshift=-1.5em, xshift=2.4em, purple] at(CP_Promocion) {(6,8,13)};
                \node[yshift=-1.5em, xshift=1.4em, purple] at(CP_Privado) {(7)};
                \node[yshift=-1.5em, xshift=1.4em, purple] at(CP_Publico) {(9)};
                \node[yshift=-1.5em, xshift=1.6em, purple] at(CP_Libre) {(10)};
                \node[yshift=-1.5em, xshift=2.2em, purple] at(CP_Proteccion) {(11,12)};
            \end{tikzpicture}
        }
