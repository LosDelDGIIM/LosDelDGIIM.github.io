...
\begin{ejercicio} \label{ej:19}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=6.3 em]
            ...
            \node[entidad debil] (vivienda) [left of=promocion, xshift=-2em, yshift=1.5em] {Vivienda} edge(promocion);
            ...
            \node[atributo] (cod_promocion) [above left of=promocion] {\key{Código}} edge(promocion);
            ...
            \node[atributo] (numero) [left of=vivienda, yshift=-2em] {\key{Número}} edge[union discriminante](vivienda);
            \node[atributo] (plano) [left of=vivienda, yshift=2em] {Plano} edge(vivienda);
