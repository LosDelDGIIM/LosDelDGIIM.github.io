...
\begin{ejercicio} \label{ej:11}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=6.3 em]
            ...
            \node[relacion] (presenta_informativo) [right of=informativo] {Presenta} edge(informativo);
...
\begin{ejercicio} \label{ej:13}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=6.3 em]
            ...
            \node[entidad] (estrella) [below right of=tipo, xshift=4em, align=center] {Alta Emisión\\(Estrella)} edge(tipo);
            
            \node[herencia] (tipo_baja) [below of=baja_emision] {Tipo} edge[participacion obligatoria] node[midway, right] {Disjunta} (baja_emision);
            ...
            \node[atributo] (distancia) [below of=gira_satelite] {Distancia} edge(gira_satelite);

            \node[relacion] (gira_planeta) [above right of=planeta] {Gira} edge(planeta) edge[-Stealth](estrella);
            ...
            \node[atributo] (fecha) [right of=objeto, align=center, node distance=10em] {Fecha\\Descubrimiento} edge(objeto);
            \node[atributo] (observatorio) [left of=objeto, yshift=-3em, node distance=8.5em] {Observatorio} edge(objeto);
            ...
            \node[entidad] (subtipo_estrella) [below of=es] {Subtipo} edge[Stealth-](es);
            ...
            \node[relacion] (es_tipo) [below of=subtipo_estrella] {Es} edge(subtipo_estrella);
            \node[entidad] (tipo_estrella) [below of=es_tipo] {Tipo} edge[Stealth-](es_tipo);
            ...
            \node[relacion] (forman) [below of=estrella] {Forman} edge(estrella);
            \node[entidad] (constelacion) [below of=forman] {Constelación} edge(forman);
            \node[atributo] (nombre_const) [left of=constelacion] {Nombre} edge(constelacion);
            \node[atributo] (cod_const) [below of=constelacion] {\key{Código}} edge(constelacion);
