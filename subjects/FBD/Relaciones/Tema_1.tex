    ...
    \begin{figure}
        ...
        \resizebox{1.1\textwidth}{!}{
            \begin{tikzpicture}[node distance=15em]
                ...
                \node[CE, xshift=17ex] (CE_Ord_Conte_Proc) at (CP_Ord_Conte) {Referencia Proc};
    ...
    \begin{figure}
        ...
        \resizebox{1.1\textwidth}{!}{
            \begin{tikzpicture}[node distance=15em]
                ...
                \node(llamada) [above of=telefono, yshift=-8em, xshift=24ex] {Llamada(Número Llamador, Fecha Inicio, Número Llamado, Fecha Fin)};
...
\begin{ejercicio} \label{ej:11}
    ...
    Notemos que $CC(*)$ denota que título no se puede repetir, pero no es totalmente una clave candidata.
    \begin{figure}
        \centering
        \resizebox{1.1\textwidth}{!}{
            \begin{tikzpicture}[node distance=15em]
    ...
    \begin{figure}
        ...
        \resizebox{1.1\textwidth}{!}{
            \begin{tikzpicture}[node distance=15em]
                ...
                \node[CP, xshift=8ex] (CP_Dirige) at (dirige) {DNI};
                \node[CC, xshift=-8ex] (CC_Dirige_Nombre) at (CP_Dirige) {Nombre};
                ...
                \node[CE] (CE_Dirige_DNI) at (CP_Dirige) {DNI};
                \node[CE, xshift=-8ex] (CE_Dirige_Nombre) at (CP_Dirige) {Nombre};
