...
\begin{ejercicio} \label{ej:8}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=6.3 em]
            ...
            \node[entidad] (portatil) [below of=tipo_pc] {Portátil} edge(tipo_pc);
            ...
            \node[atributo] (cod_proc) [below right of=procesador] {\key{Código}} edge(procesador);
...
\begin{ejercicio} \label{ej:10}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=6 em]
            ...
            \node[relacion] (formada_por) [right of=receta] {Formada} edge(receta);
            \node[entidad] (paso) [right of=formada_por] {Paso} edge(formada_por);
            ...
            \node[atributo] (cod_paso) [below left of=paso] {\key{Código}} edge(paso);

            \node[atributo] (cantidad) [above of=utiliza] {Cantidad} edge(utiliza);
            \node[atributo] (orden) [above of=formada_por] {Orden} edge[union discriminante] (formada_por);
