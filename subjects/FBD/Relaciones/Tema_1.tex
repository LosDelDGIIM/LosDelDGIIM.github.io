...
\begin{ejercicio} \label{ej:1}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=6.3 em]
            ...
            \node[atributo] (DNI_aut) [above left of=autor] {\key{DNI}} edge(autor);
            \node[atributo] (nombre_aut) [above of=autor] {Nombre} edge(autor);
            ...
            \node[atributo] (cod_tema) [above of=tema] {\key{Códigido del Tema}} edge(tema);

            
            \node[relacion] (prestamo) [below of=libro] {Préstamo} edge[-Stealth](libro);
            \node[entidad] (usuario) [below of=prestamo] {Usuario} edge(prestamo);
