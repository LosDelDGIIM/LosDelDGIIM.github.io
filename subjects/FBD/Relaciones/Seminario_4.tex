...
\begin{ejercicio}\label{ej:AR_1}
    ...
    \begin{enumerate}
        ...
        \begin{equation*}
            \pi_{\text{matrícula},\text{id\_modelo},\text{fecha\_matriculación}}(\text{Vehículo}\bowtie C)
        \end{equation*}
        ...
        pero podemos obtener los que \emph{no} cumplen la condición de el máximo.
        \begin{align*}
            & \rho(\text{Repara}) = A,B \\
            & \rho\left[\sigma_{A.\text{número\_horas} < B.\text{número\_horas}}(A \times B)\right] = C
            & \rho(\pi_{\text{A.\text{número\_horas}}}(C)) = D
        \end{align*}

        Por tanto, tenemos que en $D$ obtenemos los que no son el máximo, y por tanto, la duración más alta:
        \begin{equation*}
            \pi_{\text{número\_horas}}(\text{Repara})-D
        \end{equation*}

        Por tanto, los vehículos que han sufrido las reparaciones con la duración más alta serían:
        \begin{equation*}
            \pi_{\text{matrícula}}(\text{Repara}\bowtie D)
        \end{equation*}
        ...
        \begin{equation*}
            \pi_{\text{id\_mecánico}}(\text{Mecánico}\bowtie D)
        \end{equation*}
        \item Mecánicos cuyo salario es uno de los dos salarios más bajos.
        
        % Lo ha hecho Daniel amigo Marta Palomar
