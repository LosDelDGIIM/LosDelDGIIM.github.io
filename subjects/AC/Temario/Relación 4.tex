...
\centering
\begin{tikzpicture}
    \node[draw, square] (A) at (0,1.75) {IF};
    \node[draw, square] (B) at (1,1.75) {ID};

    \node[draw, square] (C) at (4,3.5) {LOAD 2c};
    \node[draw, square] (D) at (4,2.8) {STORE 1c};
    \node[draw, square] (E) at (4,2.1) {ADD 1c};
    \node[draw, square] (F) at (4,1.4) {ADD 1c};
    \node[draw, square] (G) at (4,0.7) {ADD 1c};
    \node[draw, square] (H) at (4,0) {MULT 4c};

    \node[draw, square] (I) at (7,1.75) {WB};

    \draw (A) -- (B)
    \draw (B) to[out=0,in=180] (C)
    \draw (B) to[out=0,in=180] (D)
    \draw (B) to[out=0,in=180] (E)
    \draw (B) to[out=0,in=180] (F)
    \draw (B) to[out=0,in=180] (G)
    \draw (B) to[out=0,in=180] (H)
    \draw (C) to[out=0,in=180] (I)
    \draw (D) to[out=0,in=180] (I)
    \draw (E) to[out=0,in=180] (I)
    \draw (F) to[out=0,in=180] (I)
    \draw (G) to[out=0,in=180] (I)
    \draw (H) to[out=0,in=180] (I)
\end{tikzpicture}
\end{figure}
