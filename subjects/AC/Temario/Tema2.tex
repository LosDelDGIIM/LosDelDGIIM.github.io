...
\begin{tikzpicture}
    ...
    \node[draw, circle, scale=1.3] (B) at (2,1.5) {$\nicefrac{n}{2}$};
    \node[draw, circle, scale=1.3] (C) at (2,4.5) {$\nicefrac{n}{2}$};
    \node[draw, circle, scale=1.3] (D) at (4,0) {$\nicefrac{n}{4}$};
    \node[draw, circle, scale=1.3] (E) at (4,2) {$\nicefrac{n}{4}$};
    \node[draw, circle, scale=1.3] (F) at (4,4) {$\nicefrac{n}{4}$};
    \node[draw, circle, scale=1.3] (G) at (4,6) {$\nicefrac{n}{4}$};
...
El tiempo de ejecución en paralelo no sólo depende del tiempo de cómputo (de cálculo) en paralelo de las tareas detectadas en la aplicación ($T_C(p)$), sino también de un tiempo de penalización o sobrecarga (\verb|overhead|) $T_O(p)$. Este tiempo de sobrecarga es debido a:
\begin{itemize}
...
% // TODO: Incluir gráfica escabilidad
\begin{enumerate}
