...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Cuando $O$ recibe el paquete \verb|PtEx(B)| de $S$ y el bloque \verb|B| está válido en cachés de otros nodos ó recibe el paquete \verb|PtLecEx(B)| de $S$ y el bloque \verb|B| está válido tanto en cachés de otros nodos como en memoria, se envía el paquete de invalidación \verb|RvInv(B)| a los nodos que tengan válido el bloque \verb|B|.
