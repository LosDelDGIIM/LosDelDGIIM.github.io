...
\begin{description}
    ...
    \item [Escritura con invalidación (\emph{write-invalidate})]~\\ 
        ...
        Notemos que invalidar es más rápido que actualizar, ya que solo necesitamos recibir la información del bloque invalidado y cambiar un bit, en lugar de reescribir el bloque completo. 
