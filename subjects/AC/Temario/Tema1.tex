\noindent
Este documento es un resumen personal elaborado con fines exclusivamente educativos y sin ánico de lucro. Su contenido se basa en la lectura y comprensión de algunos capítulos del libro ``Arquitectura de Computadores'', escrito por J. Ortega, M. Anguita y A. Prieto; y fue realizado como parte del proceso de estudio de la asignatura de mismo nombre.\\

\noindent
El resumen trata de ser un manual rápido de lectura con fines educativos, no se pretende sustuir ni reproducir la obra original. Este documento no representa ni reemplaza el contenido completo del libro, ni debe considerarse una versión oficial ni autorizada del mismo. Su publicación tiene como único propósito servir de apoyo a otros estudiantes, dentro de un marco de cooperación académica, favoreciendo el estudio y la comprensión de los temas tratados en la asignatura.\\

\noindent
En caso de que alguno de los autores de la obra original considere que este documento infringe de alguna forma sus derechos, estamos abiertos a que nos lo comunique para revisar el contenido de este resumen y, si procede, realizar las modificaciones necesarias o retirarlo de manera inmediata.
...
\begin{observacion}
    ...
    Además, en computadores MIMD tenemos más libertad en cuanto a entes del sistema operativo (procesos o \emph{threads}) que podemos usar para llevar a cabo la paralelización.
\end{observacion}
...
\subsection{Ley de Amdahl} \label{sec:amdahl}
