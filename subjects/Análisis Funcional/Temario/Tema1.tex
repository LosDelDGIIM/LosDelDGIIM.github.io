        ...
        \item Comprueba que $f\in E^\ast$ y calcula $\|f\|$.
            ...
            \begin{itemize}
                ...
                \item Para ver que $f$ es continuo:
                    ...
                    \end{align*}
            \end{itemize}
            Por lo que $f\in E^\ast$. En este último punto hemos visto también que $\|f\|\leq 1$. % // TODO: TERMINAR
        \item ¿Puede encontrarse $u\in E$ con $\|u\| = 1$ y $f(u) = \|f\|$?
    \end{enumerate}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item Construye un funcional lineal $f:E\to \mathbb{R}$ que no sea continuo. % // TODO: TERMINAR
            ...
            \begin{itemize}
                ...
                \item Para $Int C$, sean $x,y\in Int C$, entonces existe $r>0$ de forma que $B(x,r),B(y,r)\subset C$. En dicho caso, como $C$ es convexo, tenemos que:
                    ...
                    \begin{description}
                        ...
                        \item [$\supset)$]  % // TODO: Hacer
                    \end{description}
            \end{itemize}
        \item Dado $x\in C$ y $y\in Int C$, prueba que $tx+(1-t)y\in Int C\quad \forall t\in \left]0,1\right[$ . % // TODO: Terminar
            \begin{itemize}
                \item Si $x\in Int C$, como vimos en el apartado anterior que $Int C$ era convexo, tenemos el resultado.
                \item Si $x\in C\setminus Int C \subset \overline{C}$, 
            \end{itemize}
