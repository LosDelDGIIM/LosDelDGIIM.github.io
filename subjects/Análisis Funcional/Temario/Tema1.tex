...
\begin{teo}[Desigualdad de Minkowski]
    Para $p\in \mathbb{R}$ con $p\geq 1$ y $f\in \cc{L}_p(\Omega)$, $g\in \cc{L}_{p'}(\Omega)$, se cumple que:
    \begin{equation*}
