    ...
    \begin{proof}
        ...
        \begin{description}
            ...
            \item [Paso 2.] Veamos ahora que $B\left(0,\frac{r}{2}\right)\subset T(B(0,1))$.
                ...
                \begin{equation*}
                    \sum_{k=1}^{\infty}T(x_k) = y
                \end{equation*}
                Finalmente:
                \begin{align*}
                    T(x) &= T\left(\sum_{k=1}^{\infty}x_k\right) = T\left(\lim_{n\to\infty}\sum_{k=1}^{n}x_k\right) \AstIg \lim_{n\to\infty}T\left(\sum_{k=1}^{n}x_k\right) \\ &= \lim_{n\to\infty}\sum_{k=1}^{n}T(x_k) = \sum_{k=1}^{\infty}T(x_k)  = y
                \end{align*}
...
\begin{coro}\label{coro:equivalencia_normas}
    ...
    \begin{proof}
        ...
        \end{equation*}
        por lo que $T$ es continua. Es claro que también $T\in L(E,E)$ es biyectiva, con lo que por el Corolario anterior tenemos que $T^{-1}$ es también continua. Es obvio que $T^{-1}:(E,\|\cdot \|_2)\to (E,\|\cdot \|_1)$ viene dada por $T^{-1}(x) = x$. Es claro que se verifica la igualdad:
        \begin{equation*}
