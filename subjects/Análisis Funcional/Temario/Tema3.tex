...
\begin{teo}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            J(\overline{B}_{E}) = \overline{B}_{E^{\ast\ast}} = \overline{B}_{{(E^\as)}^{\ast}}
        \end{equation*}
...
\noindent
La afirmación recíproca es también cierta\footnote{Excede los conocimientos del curso.}, y se conoce como Teorema de Kakutani.

% // TODO: Proposiciones de ejercicio:
% Banach reflexivo => todo subespacio vectorial cerrado es reflexivo
% esp de Banach, esp reflexivo <=> dual reflexivo
