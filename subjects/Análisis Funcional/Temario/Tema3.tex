    ...
    \begin{proof}
        ...
        \begin{enumerate}
            \item[$i)$] Como $E$ es separable, será también $\overline{B}_{E}$ un conjunto separable, luego existe $\{x_n:n\in \mathbb{N}\}\subset \overline{B}_E$ denso. Definimos ahora para cada $f\in E^\ast$ con $\|f\| \leq 1$:
                ...
                \begin{equation*}
                    \left|\frac{1}{2^n}\langle f,x_n \rangle \right| \leq \frac{1}{2^n}\|f\| \|x_n\| \leq \frac{1}{2^n} \qquad \forall n\in \mathbb{N}
                \end{equation*}
                Por lo que la serie $\sum\limits_{n=1}^{\infty}\frac{1}{2^n}\langle f,x_n \rangle $ es absolutamente convergente en $\mathbb{R}$, luego será convergente.
                \begin{itemize} % // TODO: HACER:
                    \item Probar que $[f]$ es una norma.
