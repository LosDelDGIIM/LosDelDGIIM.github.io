...
\begin{ejercicio}\label{ej:5_rel2}
    ...
    Por lo que:
    \begin{equation*}
        \|g_n\| = \|f_n\|(1-\varepsilon_n\|g_n\|) \quad \Longrightarrow \quad \|f_n\| = \frac{\|g_n\|}{1-\varepsilon_n\|g_n\|}
    \end{equation*}
    Si $\{\varepsilon_n\}\to 0$ tenemos que está acotada, por lo que existe $M\in \mathbb{R}^+$ de forma que $\varepsilon_n\leq M\quad \forall n\in \mathbb{N}$. Tenemos que:
    \begin{equation*}
        1-\varepsilon_n\|g_n\| \geq 1-MC
    \end{equation*}
    de donde:
    \begin{equation*}
        \|f_n\| = \frac{\|g_n\|}{1-\varepsilon_n\|g_n\|} \leq \frac{C}{1-MC}
    \end{equation*}
    Por lo que la sucesión $\{f_n\}$ está acotada.
\end{ejercicio}
