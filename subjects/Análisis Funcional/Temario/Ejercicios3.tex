...
\begin{ejercicio}
    Sea $E$ un espacio de Banach de dimensión infinita. Nuestro propósito es demostrar que $(E,\sigma(E,E^\ast))$ no es metrizable. Spuongamos por reducción al absurdo que existe una distancia $d$ en $E$ que induce la topología $\sigma(E,E^\ast)$.
    \begin{enumerate}
...
\begin{ejercicio}
    Sea $E$ Un espacio de Banach, sea $M\subset E$ un subespcio vectorial y sea $f_0\in E^\ast$. Prueba que existe $g_0\in M^\perp$ de forma que
    \begin{equation*}
