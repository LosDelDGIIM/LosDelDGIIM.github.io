...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item ¿Puede encontrarse $u\in E$ con $\|u\| = 1$ y $f(u) = \|f\|$? % // TODO: TERMINAR
...
\begin{ejercicio}% // TODO: HACER
    ...
    \begin{enumerate}[label=\alph*)]
        \item Sea $\{x_n\}_{n\in \mathbb{N}}$ subconjunto numerable de $C$ que es denso en $C$ (¿por qué existe?). Para cada $n$ definimos:
            ...
            Finalmente, para ver que $C_n$ es compacto para cada $n\in \mathbb{N}$, fijado $n\in \mathbb{N}$ si consideramos una sucesión de elementos de $C_n$ (indexada en $k$): % // TODO: Arreglar esto
            \begin{equation*}
...
\begin{ejercicio}
    ...
    \begin{description}
        ...
        \item [$2\Longrightarrow 1)$] % // TODO: TERMINAR
    \end{description}
\end{ejercicio}
