...
\begin{ejercicio}% // TODO: HACER
    ...
    \begin{enumerate}[label=\alph*)]
        \item Sea $\{x_n\}_{n\in \mathbb{N}}$ subconjunto numerable de $C$ que es denso en $C$ (¿por qué existe?). Para cada $n$ definimos:
            ...
            \end{equation*}
            Por lo que nuestra sucesión de partida admite una parcial convergente, lo que prueba que $C_n$ es compacto, para cada $n\in \mathbb{N}$.
        \item Prueba que existe un $f_n \in E^\ast$ de forma que:
            \begin{equation*}
                \|f_n\| = 1 \quad \text{y}\quad f_n(x) \geq 0 \quad \forall x\in C_n
            \end{equation*}

            Fijado $n\in \mathbb{N}$, buscamos aplicar la segunda versión geométrica del Teorema de Hahn-Banach. Para ello, observemos que como $C_n\subset C$ con $0\notin C_n$ no puede ser $0\in C_n$, por lo que tenemos $\{0\}\cap C_n = \emptyset $ con $\{0\}$ un conjunto cerrado y $C_n$ un conjunto compacto. Aplicando el Teorema enunciado tenemos que existen $g_n\in E^\ast$ y $\alpha\in \mathbb{R}$ de forma que:
            \begin{equation*}
            ...
            \begin{itemize}
                ...
                \item Tenemos que:
                    \begin{equation*}
                        \|f_n\| = \sup_{\|x\|\leq 1}|f_n(x)| = \sup_{\|x\|\leq 1}\frac{|g_n(x)|}{\|g_n\|} = \frac{1}{\|g_n\|}\sup_{\|x\|\leq 1}|g_n(x)|= \frac{\|g_n\|}{\|g_n\|} = 1
                    \end{equation*}
            \end{itemize}
        ...
        \item Sean $A,B\subset E$ conjuntos no vacíos disjuntos y convexos. Prueba que existe algún hiperplano $H$ que separa $A$ y $B$.
            ...
            \end{equation*}
            Por lo que el hiperplano $H=[f=0]$ separa $\{0\}$ y $C$; y repitiendo la demostración de la primera versión geométrica del Teorema de Hahn-Banach llegamos a que existe algún hiperplano cerrado $H$ que separa $A$ y $B$.
    \end{enumerate}
\end{ejercicio}
