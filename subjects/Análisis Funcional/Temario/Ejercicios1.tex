...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        \item Probar que $V=H$ o $V=E$.
            ...
            \end{equation*}
            Como $dim \mathbb{R} = 1$ y $f$ \underline{no se anula}, tenemos que $f(E)$ es un subespacio vectorial mayor que $\{0\}$, por lo que no queda más salida que $f(E) = \mathbb{R}$. En definitiva:
            \begin{equation*}
