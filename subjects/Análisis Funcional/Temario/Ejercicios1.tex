    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item Sea $E = C([0,1], \mathbb{R})$ con la norma:
            ...
            \begin{itemize}
                ...
                \item % // TODO: DE CARLOS
                    Para ver que $C$ es convexo, veamos que si $u,v\in C$ entonces $w=\lm u+(1-\lm)v\in C$, para $\lm \in [0,1]$. Para ello, si denotamos por $\|\cdot \|_2$ a la norma en $L^2$:
                    \begin{equation*}
                        \|u\|_2 = {\left(\int_{0}^{1} {|u(t)|}^{2}~dt \right)}^{\frac{1}{2}}
                    \end{equation*}
                    Observamos que:
                    \begin{equation*}
                        \|w\|_2 = \|\lm u + (1-\lm)v\|_2 \leq \lm\|u\|_2 + (1-\lm)\|v\|_2 \leq \lm + (1-\lm) = 1
                    \end{equation*}
                    Por lo que $w\in C$.
                \item % // TODO: DE CARLOS
                    Veamos que $C$ no está acotado, pues podemos considerar:
                    \begin{equation*}
                        u_n(t) = \frac{\sqrt{n}}{1+nt} \qquad \forall t\in [0,1]
                    \end{equation*}
                    Que son funciones de $C$:
                    \begin{equation*}
                        \int_{0}^{1} {|u_n(t)|}^{2}~dt  = \int_{0}^{1} \frac{n}{(1+nt^2)}~dt  = \int_{1}^{1+n} \frac{1}{s^2}~ds  = \left[\frac{-1}{S}\right]_1^{1+n} = \frac{n}{n+1} < 1 \qquad \forall n\in \mathbb{N}
                    \end{equation*}
                    Y cumplen:
                    \begin{equation*}
