...
\begin{enumerate}[label={\alph*)}]
    ...
    \begin{description}
        ...
        \begin{equation*}
            \|y - b - a\| = \|y - (a + b)\| = \|y - x\| < r
        \end{equation*}
        Por tanto, $y - b \in U(a, r) \subset A$, y como $b \in B$, se concluye que $y = (y - b) + b \in A + B$. Por tanto, $U(x, r) \subset A + B$, y como $x \in A + B$ es arbitrario, se concluye que $A + B$ es abierto.
