...
\subsection{Propiedades trigonométricas}
A continuación, destacamos algunas identidades trigonométricas que son útiles en el cálculo de integrales simples:
\begin{align*}
    \sen(2x) &= 2\sen x\cos x \\
    \cos(2x) &= \cos^2 x - \sen^2 x \\
    \cos^2 x &= \dfrac{1+\cos 2x}{2} \\
    (\tan x)' &= \tan^2 x + 1 = \sec^2 x \\
