...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        Por tanto, la integral indefinida queda:
        \begin{align*}
            \int \frac{dx}{x^3+1}
            &= \int \frac{\nicefrac{1}{3}}{x+1}+\frac{\nicefrac{-1}{3}x+\nicefrac{2}{3}}{x^2-x+1}\;dx
            = \frac{1}{3}\int \frac{1}{x+1}\;dx + \frac{1}{3}\int \frac{-x+2}{x^2-x+1}\;dx =\\
            &= \frac{1}{3}\ln |x+1| + \frac{1}{3}\cdot \red{-\frac{1}{2}}\int \frac{\red{2}x-4}{x^2-x+1}\;dx =\\
            &= \frac{1}{3}\ln |x+1| - \frac{1}{6}\ln |x^2-x+1| -\frac{1}{6} \int \frac{-3}{\left(x - \nicefrac{1}{2}\right)^2 -\frac{1}{4}+1}\;dx =\\
            &= \frac{1}{3}\ln |x+1| - \frac{1}{6}\ln |x^2-x+1| +\frac{1}{2} \int \frac{1}{\frac{3}{4}+\left(x - \nicefrac{1}{2}\right)^2}\;dx =\\
            &= \frac{1}{3}\ln |x+1| - \frac{1}{6}\ln |x^2-x+1| +\frac{1}{2}\cdot\frac{4}{3} \int \frac{1}{1+\left(\frac{2}{\sqrt{3}}x - \nicefrac{1}{\sqrt{3}}\right)^2}\;dx =\\
            &= \frac{1}{3}\ln |x+1| - \frac{1}{6}\ln |x^2-x+1| +\frac{1}{2}\cdot\frac{4}{3}\cdot \red{\frac{\sqrt{3}}{2}} \int \frac{\red{\frac{2}{\sqrt{3}}}}{1+\left(\frac{2}{\sqrt{3}}x - \nicefrac{1}{\sqrt{3}}\right)^2}\;dx =\\
        ...
        \begin{align*}
            ...
            &= \left[\frac{1}{3}\ln |x+1| - \frac{1}{6}\ln |x^2-x+1| +\frac{\sqrt{3}}{3}\arctan \left(\frac{2x-1}{\sqrt{3}}\right)\right]_0^1 =\\
            &= \frac{1}{3}\ln 2 - \frac{1}{6}\ln 1 +\frac{\sqrt{3}}{3}\arctan \left(\frac{1}{\sqrt{3}}\right)
            - \left[\ln 1 - \ln 1 +\frac{\sqrt{3}}{3}\arctan \left(\frac{-1}{\sqrt{3}}\right)\right] =\\
            &= \frac{1}{3}\ln 2 +\frac{\sqrt{3}}{3}\arctan \left(\frac{1}{\sqrt{3}}\right)
            - \frac{\sqrt{3}}{3}\arctan \left(\frac{-1}{\sqrt{3}}\right) =\\
            &= \frac{1}{3}\ln 2 +\frac{2\sqrt{3}}{3}\arctan \left(\frac{1}{\sqrt{3}}\right)
            = \frac{1}{3}\ln 2 +\frac{2\sqrt{3}}{3}\cdot \frac{\pi}{6} = \frac{1}{3}\ln 2 +\frac{\sqrt{3}\pi}{9}
        \end{align*}    
