...
\begin{document}
    ...
    \portadaExamen{ffccA4.jpg}{Cálculo II\\Examen XVI}{Cálculo II. Examen XVI}{MidnightBlue}{-8}{28}{2024}
    {\begin{center}
...
\begin{ejercicio}
        ...
        \begin{enumerate}[label=\alph*)]
            ...
            \begin{enumerate}
                \item $F''(x)=(6x^2+4)e^{-(x^2+2)}+e^{-(x^2+2)}\cdot -2x \cdot (2x^3+4x) \newline = e^{-x^2-2}[(6x^2+4)+(-4x^4-8x^2)]$
