...
\begin{ejercicio}\label{ej:2.2.2}
    ...
    \begin{enumerate}
        ...
        % // TODO: Por qué no puedo aproximarlo por xhi desde el principio?
        % // TODO: No es para algun xhi? Por qué derivo asi?
        ...
        \begin{align*}
            ...
            E''(a) &= 2f[a-h, a, a+h, a, a, a]\Pi(a) + 2f[a-h, a, a+h, a, a]\Pi'(a)+f[a-h, a, a+h, a]\Pi''(a)
        \end{align*}

        Por ser de tipo interpolatorio clásico, el error de la fórmula es:
        \begin{align*}
            R(f) &= L(E) = 2E'(a) - E''(a) \\
            &= 2\left(\dfrac{f^{(4)}(\xi)}{4!}(2a-h)(2a+h)\right) - \dfrac{f^{(4)}(\xi)}{4!}(2) \\
        \end{align*}
