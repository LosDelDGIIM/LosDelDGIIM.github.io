...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        Sabemos que $\sen\left(\nicefrac{\alpha}{3}\right)$ es solución de la ecuación $p(x) = 0$, y además sabemos que, de haber solución en el intervalo $\left]0,\nicefrac{a}{2}\right[$, esta es única; puesto que tenemos $\left]0,\nicefrac{a}{2}\right[\subset \left]0,\nicefrac{1}{2}\right[$. Por tanto, tan solo nos queda demostrar que $\sen\left(\nicefrac{\alpha}{3}\right)\in \left]0,\nicefrac{a}{2}\right[$.\\
        
        % // TODO: Completar demostración

        Comprobamos ahora que el método de Newton-Raphson converge para $x_0 = \nicefrac{a}{3}$ y $x_0 = \nicefrac{a}{2}$. Para ello, calculamos $f'(x)$:
        \begin{align*}
            f'(x) &= -12x^2 + 3=0\iff x=\pm \dfrac{1}{2}
        \end{align*}
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                f(0) &= -a<0\\
                f\left(\dfrac{1}{2}\right) &= -\frac{1}{2}+\dfrac{3}{2}-a = 1-a>0
            \end{align*}
            Por tanto, se cumple la condición.

            \item $f'(x)\neq 0$ para $x\in \left]0,\nicefrac{1}{2}\right[$.
            \item $f''(x)$ no cambia de signo en $\left]0,\nicefrac{1}{2}\right[$.
            \item Comprobemos la última condición para cada uno de los valores iniciales:
            \begin{align*}
                f(\nicefrac{a}{3}) &= -4\left(\dfrac{a}{3}\right)^3 + 3\left(\dfrac{a}{3}\right) - a = -\dfrac{4a^3}{27} + a - a = -\dfrac{4a^3}{27}<0\\
                f''\left(\nicefrac{a}{3}\right) &= -24\cdot \frac{a}{3}<0
            \end{align*}
            Por tanto, se cumple la condición para $x_0 = \nicefrac{a}{3}$.
            \begin{align*}
                f\left(\nicefrac{a}{2}\right) &= -4\left(\dfrac{a}{2}\right)^3 + 3\left(\dfrac{a}{2}\right) - a = -\dfrac{a^3}{2} + \dfrac{3a}{2} - a = -\dfrac{a^3}{2} + \dfrac{a}{2} = \dfrac{a}{2}(1-a^2)>0\\
                f''\left(\nicefrac{a}{2}\right) &= -24\cdot \frac{a}{2}<0
            \end{align*}
        \end{enumerate}
