...
\section{Semántica de las operaciones de paso de mensajes} % repasar esto
...
Una orden con guarda comienza con la palabra reservada \verb|when|, y en ella podemos encontrar dos partes bien diferenciadas:
\begin{itemize}
