...
\begin{ejercicio*}
    ...
    \begin{multicols}{2}
        ...
        \end{minted}
    \end{multicols}
    En primer lugar, notamos que el monitor de la izquierda realiza una instrucción \verb|if| antes de llamar a la operación \verb|wait|, luego sólo isrve para semánticas desplazantes.
