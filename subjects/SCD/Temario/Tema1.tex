        ...
        \item $x=x+2$ no interfiere con $\{V\}\ x=0\ \{x=0 \lor x=2\}$:
            \begin{enumerate}
                \item Para la precondición:
                    ...
                    \end{equation*}
                    Se cumple por la regla de la consecuencia (1), ya que se verifica que $\{x=0\}\ x=x+2\ \{x=2\}$, $\{x=2\} \rightarrow \{V\}$.
                \item Para la poscondición:
                    \begin{equation*}
                        \{x=0\} \equiv \{(x=0 \lor x=2)\land x=0\}\ x=x+2\ \{x=0 \lor x=2\}
                    \end{equation*}
                    Se cumple por la regla de la consecuencia (1), ya que se verifica que $\{x=0\}\ x=x+2\ \{x=2\}$, $\{x=2\} \rightarrow\{x=0 \lor x=2\}$.
            \end{enumerate}
        \item $x=0$ no interfiere con $\{x=0\}\ x=x+2\ \{x=0 \lor x=2\}$:
            \begin{enumerate}
                \item Para la precondición:
                    ...
                    \end{equation*}
                    Se cumple por la regla de la consecuencia (1), ya que se verifica que $\{x=0\}\ x=0\ \{x=0\}$ y $\{x=0\}\rightarrow \{x=0 \lor x=2\}$.
                \item Para la poscondición:
                    \begin{equation*}
                        \{x=0 \lor x = 2\} \equiv \{(x=0 \lor x=2)\land V\}\ x=0\ \{x=0 \lor x=2\}
                    \end{equation*}
                    Se cumple por la regla de la consecuencia (1), ya que se verifica que $\{x=0 \lor x=2\}\ x=0\ \{x=0\}$ y $\{x=0\}\rightarrow \{x=0 \lor x=2\}$.
            \end{enumerate}
    \end{itemize}
\end{ejemplo}
...
\begin{description}
    \item [Regla de la composición concurrente segura de procesos.] 
        \begin{equation*}
            \dfrac{\{P_i\}\ S_i\ \{Q_i\} \text{ son triples libres de interferencia } \forall 1\leq i \leq n}{\{P_1 \land P_2 \land \ldots \land P_n\} \texttt{ cobegin } S_1\ ||\ S_2\ ||\ \ldots\ ||\ S_n \texttt{ coend } \{Q_1 \land Q_2 \land \ldots \land Q_n\}}
        \end{equation*}
\end{description}
