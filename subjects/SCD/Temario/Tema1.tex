...
En los programas secuenciales, para comprobar la corrección de los mismos, debemos probar que el programa \textbf{termina} dando \textbf{salidas esperadas} ante determinadas entradas.
...
\end{description}
De esta forma, el únifco enfoque posibles es el razonamiento asertivo.
