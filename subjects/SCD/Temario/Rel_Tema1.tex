...
\end{align*}
Este triple efectivamente es cierto, lo cual se puede demostrar empleando en primer lugar el Axioma de Sustitución y, posteriormente, la segunda regla de la consecuencia.\\
