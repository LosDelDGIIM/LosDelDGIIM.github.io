...
\begin{ejercicio}
    ...
    \begin{align*}
        ...
        Q_2 &= (x=0\lor x=a) \land (y=b \lor y=a+b) \land z=0
    \end{align*}
    ...
    \begin{enumerate}
        ...
        De la definición de Sustitución Textual, tenemos que:
        \begin{multline*}
            \{(x=0\lor x=a) \land (y=b \lor y=a+b) \land z = 0\}_{x+b}^y \equiv \\ \equiv \{(x=0\lor x=a) \land (x+b=b \lor x+b=a+b) \land z = 0\} \equiv \\ \equiv \{(x=0\lor x=a) \land (x=0\lor x=a) \land z=0\}
            \equiv \{(x=0\lor x=a) \land z=0\}
        \end{multline*}

        Por tanto, del Axioma de Asignación, tenemos que:
        \begin{multline*}
            \{(x=0\lor x=a) \land z=0\} <y = x + b> \\ \{(x=0\lor x=a) \land (y=b \lor y=a+b) \land z = 0\}
        \end{multline*}
    ...
    \begin{align*}
        ...
        NI(Q_2, S_1) & \equiv \{x=0 \land y=b \land z=0\} <x=z+a>\\&\hspace{5cm} \{(x=0\lor x=a) \land (y=b \lor y=a+b) \land z=0\} \\
