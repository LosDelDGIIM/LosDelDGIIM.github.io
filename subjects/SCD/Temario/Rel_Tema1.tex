...
\begin{ejercicio}
    ...
    % // TODO: JJ Revisar. Me ha parecido bastante difícil
\end{ejercicio}
...
\begin{ejercicio}
    ...
    % // TODO: Preguntar a Capel
    % {x=0} cobegin <x=x+a>; <x=x+a> coend; {x=2*a}       no se puede demostrar
    % {x=0} cobegin <x=x+a>; <x=x+a> coend; {x=2*a  o   x=a}    es cierto
\end{ejercicio}
...
\begin{ejercicio}
    ...
    % // TODO: JJ Revisar
    % // Este ha sido fácil. Intuición? Cómo verlo directo sin escribir todo?
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \begin{equation*}
        \{i>2\}\ i=2\ast i\ \{i>4\}
    \end{equation*}
    % // TODO: Regla de la conjunción?. Se demuestra directamente con el axioma de asignación
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \end{minted}
    % // TODO: Cómo demostrar que termina?
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \end{equation*}
    % // TODO: JJ. Tenemos que considerar i=j?
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \begin{equation*}
        \{V\}\ k=0;\ fact=1;\ \{I\}
    \end{equation*}
    % // TODO: JJ. Podemos suponer afact y bfact=1?
    Lo cual es directamente cierto. Posteriormente, hemos de demostrar el triple $\{I \land B\}\ S\ \{I\}$ con $\{B\} \equiv \{k \neq n\}$ y $S$ el cuerpo del bucle para poder aplicar la regla de iteración:
    \begin{gather*}
...
\begin{ejercicio}
    ...
    % // TODO: Cómo demostrar la terminación?
\end{ejercicio}
