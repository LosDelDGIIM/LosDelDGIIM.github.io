...
\begin{ejercicio}
    ...
    \begin{equation*}
        \{i>2\}\ i=2\ast i\ \{i>4\}
    \end{equation*}
    % // TODO: JJ. Regla de la conjunción?. Se demuestra directamente con el axioma de asignación
\end{ejercicio}
...
\begin{ejercicio}
    ...
    % // TODO: Arturo se ha quedado por este ejercicio
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \end{minted}
    % // TODO: JJ. Cómo demostrar que termina?
\end{ejercicio}
