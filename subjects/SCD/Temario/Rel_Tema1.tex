...
% // TODO: Copiar ejercicios del [17, 21]
...
\begin{ejercicio} % 18
    Suponer que $\{suma>1\}\ suma=suma+4\ \{suma>4\}$ es demostrable, entonces: ¿cuál de los siguientes triples es también demostrable? (indicar por qué)
    \begin{enumerate}[label=(\alph*)]
...
\begin{ejercicio}[22 de la relación]
...
% // TODO: COpiar ejercicio 23

\begin{ejercicio}[24 de la relación]
...
% // TODO: copiar ejercicios [25, 27]

\begin{ejercicio}[28 de la relación]
...
% // TODO: COpiar ejercicios [29 - 32]

\begin{ejercicio}[33 de la relación]
    ...
    \begin{enumerate}
        \item Para demostrar el primer triple, usamos el axioma de asignación:
            ...
            \begin{gather*}
                ...
                \equiv \left\{sum = \frac{(j+1)j}{2}-j \land j \neq c\right\} \euiv \left\{sum = \frac{j(j-1)}{2} \land j \neq c\right\}
            \end{gather*}
