...
\begin{definicion}[Conjunto cerrado] Sea $(X,\cc{T})$ un espacio topológico. Diremos que $F\subset X$ es cerrado si $X\setminus F$ es abierto; es decir, si $X\setminus F\in \cc{T}$.
...
\begin{ejemplo} Veamos algunos ejemplos del Teorema anterior:
    \begin{enumerate}
...
Sea $(X,\T)$ un espacio topológico, y consideramos $x\in X$. Tenemos que algunas propiedades que se deducen del sistema de entornos de $x$ son:
\begin{enumerate}
    \item[N1)] $N_x\neq \emptyset$.
