...
% // Existencia de m y M en R
% https://www.ugr.es/~cdpye/CursoProbabilidad/pdf/P_T03_FuncionDistribucion.pdf
\item El conjunto de puntos de discontinuidad de una función de distribución es numerable.

% // El conjunto de puntos de discontinuidad de una función de distribución es numerable
...
\begin{coro}
    ...
    \end{equation*}
\end{coro}
% // Demostración CV continua a continua
...
\begin{teo}
    ...
    \end{enumerate}
\end{teo}
% // Demostración del teorema de CV continuo con esperanza
