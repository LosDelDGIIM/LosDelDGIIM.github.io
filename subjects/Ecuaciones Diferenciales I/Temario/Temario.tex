...
\begin{document}
    ...
    \newpage
    La parte de teoría del presente documento (es decir, excluyendo las relaciones de problemas) está hecha en función a los apuntes que se han tomado en clase.
