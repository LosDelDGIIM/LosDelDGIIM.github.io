...
\begin{teo}[Existencia y unicidad de las soluciones]\label{teo:existencia_unicidad_sistemas}
 ...
 :                           \end{equation*}
                        ...
                        \begin{equation*}
                            \int_{t_n}^{t} A(s)x_n(s)~ds  \rightarrow \int_{t_0}^{t} A(s)x(s)~ds 
                        \end{equation*}
                        En definitiva:
                        \begin{equation*}
                            x(t) = x_0 + \int_{t_0}^{t} [A(s)x(s)+b(s)]~ds 
                        ...
                        \end{equation*}
                        Con lo que $x$ es solución de la ecuación y se tiene que:
                        \begin{equation*}
                            x(t_0) = x_0
                        \end{equation*}
                    \item [Unicidad.] Supongamos que $x,y:I\rightarrow\mathbb{R}^d$ son ambas soluciones de la ecuación diferencial para la misma condición inicial $t_0 \in I$, $x_0 \in \mathbb{R}^d$. Como son soluciones, también cumplen la ecuación integral:
                        \begin{align*}
                            x(t) &= x_0 + \int_{t_0}^{t} [A(s)x(s)+b(s)]~ds \\
...
Supongamos que $\lm \in \sigma(A)\cap \mathbb{R}$ es un valor propio no trivial de $A$, siendo $v\in \mathbb{R}^d\setminus\{0\}$ un vector propio asociado a $\lm$.
