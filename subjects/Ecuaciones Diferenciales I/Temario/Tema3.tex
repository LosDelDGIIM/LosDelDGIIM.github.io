...
\begin{teo}
    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \item Además, $P$ y $Q$ son funciones continuas, luego integrables en cualquier conjunto compacto (como lo es $[0,1]$), luego podemos calcular dichas integrales.
        \end{itemize}
...
\begin{ejemplo}
    ...
    \end{equation*}
    Y sabemos (gracias a la Proposición~\ref{prop:resolver_exactas}) que la ecuación~(\ref{eq:exacta_ejm}) podemos ponerla como la derivada de una función de una variable igualada a 0. Por tanto, sabemos que las soluciones pueden escribirse como:
    \begin{equation*}
