...
Antes de pasar a la siguiente sección y con objetivo a asentar todos los conceptos desarrollados en esta, realizaremos el siguiente ejercicio, el cual asentará conceptos importantes viéndolos de forma práctica.
...
\begin{ejercicio*}
    ...
    \end{equation*}
    de clase $C^1(\Omega)$. Y lo primero para ver si estas admiten un potencial será comprobar si cumplen con la condición de exactitud:
    \begin{equation*}
    ...
    \end{itemize}
    Nos decantaremos por la segunda opción, por tener cálculos más sencillos.\\
