...
\begin{prop}
    ...
    \begin{proof}
        ...
        \begin{multline*}
            D'(t) = \sum_{\sigma\in S_k} \veps(\sigma) f_{1\sigma(1)}'(t) f_{2\sigma(2)}(t)\ldots f_{k\sigma(k)}(t) +\\ + \sum_{\sigma\in S_k} \veps(\sigma) f_{1\sigma(1)}(t) f_{2\sigma(2)}'(t)\ldots f_{k\sigma(k)}(t) + \sum_{\sigma\in S_k} \veps(\sigma) f_{1\sigma(1)}(t) f_{2\sigma(2)}(t)\ldots f_{k\sigma(k)}'(t)
        \end{multline*}
