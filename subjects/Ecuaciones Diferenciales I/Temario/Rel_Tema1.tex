...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        \end{equation*}
        Notemos que, en el caso de $x_0=0$, también se cumple que $y_t = y(x_0)-0\cdot y'(x_0) = y(x_0)$. Respecto a la recta normal, tenemos que:
        \begin{equation*}
            \left. \begin{aligned}
                m_n &= -\dfrac{1}{y'(x_0)}\\
                P_n &= (x_n, 0)
        ...
        \end{equation*}
        % // TODO: JJ, Revisar.
        % // TODO: ¿Qué hacer con los puntos que no lo cumplen??
    \end{enumerate}
\end{ejercicio}
