...
% // TODO: Cambiar esto a teorema o proposicion
\noindent
...
A dicha función inversa, la llamaremos $T$: $t = T(x)$ inversa de $x=\varphi(t)$, $T:J\rightarrow I$ derivable, cuya derivada se calcula como:
\begin{equation*}
