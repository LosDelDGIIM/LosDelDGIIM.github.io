...
\begin{document}
    ...
    \begin{ejercicio}
        ...
        \end{equation*}
        Este conjunto sabemos que es abierto.Para ver que es conexo, veremos que es estrellado desde el origen. Sea $(x,y)\in\Omega$, entonces $y+e^x>0$. Tenemos que:
        \begin{multline*}
        ...
        \end{multline*}
        que es cierto por hipótesis. Por tanto, ese dominio es válido. Comprobemos ahora que la ecuación diferencial es exacta.
        Definimos:
