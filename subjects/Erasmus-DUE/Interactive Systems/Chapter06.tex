...
% // TODO: Memorizar Activity Theory triangle
\begin{figure}
    \centering
...
\begin{itemize}
    ...
    \item \ul{Rules}: The norms, conventions, and regulations that govern the activity.
...
% // TODO: Memorizar clasification of attributions
...
\begin{itemize}
    ...
    A common risk associated with extrinsic motivation is that it can undermine intrinsic motivation. When users are primarily motivated by external rewards, they may lose interest in the activity itself and become less engaged over time.
\end{itemize}
