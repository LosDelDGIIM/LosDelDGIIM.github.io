...
\begin{itemize}
    \item \ul{Users}: needs and requirements.
    \item \ul{Situation}: what is the current state of the problem.
    \item \ul{Context}: location, legislation, culture, etc.
\end{itemize}
...
In order to design effective interactive systems, \emph{triangulation} is often used, which involves combining multiple research methods to gain a comprehensive understanding of the design space. Using these research methods, theory and practice can be combined:
\begin{itemize}
    \item \ul{Induction}: Theory is derived from practice, and it is used to generate new insights and understanding about the design space.
    \item \ul{Deduction}: Theory is used to inform practice and create hypotheses, and it is applied to guide the design and development of interactive systems.
\end{itemize}
...
% // TODO: Explain the three types of AR
\begin{description}
...
% // TODO: Explain the two approaches to research in experimental research
\begin{itemize}
...
% // TODO: Stages in survey research
\begin{enumerate}
    ...
    % // TODO: Population groups considered in Survey Research
    \begin{itemize}
    ...
    \begin{itemize}
        \item \emph{Data Logging}: recording additional information about respondents' interactions with the survey, such as the time taken to complete the survey or the order of responses. This can provide valuable insights into respondents' behavior and can help identify potential issues with the survey design.
