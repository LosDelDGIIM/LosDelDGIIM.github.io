...
\begin{ejercicio}
    Please indicate for the following cases below which study method you would try to use to solvethe following issue and why, as well as how many participants (approximately) you would recruit and why. Consider everything you have learned in the lecture and teaching cases.
    \begin{enumerate}
