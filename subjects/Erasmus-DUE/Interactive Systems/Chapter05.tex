...
In order to design effective interactive systems, the human should always be at the center of the design process. The specific phases of the user centered design (UCD) according to ISO 9241-210 are:
\begin{enumerate}
...
The participation of the stakeholders in the design process is crucial for creating effective interactive systems, and therefore the \emph{stakeholders analysis} is important. Some aspects of participation include:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Mockup: a simple prototype that represents the visual design of the system, \emph{but does not have any functionality}.
