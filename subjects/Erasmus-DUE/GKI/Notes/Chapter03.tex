...
% // TODO: Memorizar Adjacency Matrix, Adjacency List, transition Matrix
...
Sorting algorithms are a fundamental part of computer science, as they allow us to organize data in a specific order. In addition, they are used in many search algorithms, as they can help to reduce the search space and improve the efficiency of the search. Some useful interactive applets to visualize sorting algorithms are:
\begin{itemize}
    \item \myhref{https://visualgo.net/en/sorting}{This interactive applet} shows the most common sorting algorithms and displays the pseudo-code of each algorithm.
    \item \myhref{https://www.cs.usfca.edu/~galles/visualization/Algorithms.html}{This other interactive applet} however only shows the process, but it has a wider variety of algorithms.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Move all the elements of the sorted part that are greater than the current element to the right.
...
Uninformed search algorithms are those that do not have any additional information about the search space. They explore the search space in a systematic way, without any guidance or heuristics. Some useful interactive applets to visualize uninformed search algorithms are:
\begin{itemize}
    \item \myhref{https://visualgo.net/en/dfsbfs}{This interactive applet} shows the most common uninformed search algorithms and displays the pseudo-code of each algorithm.
    \item \myhref{https://www.cs.usfca.edu/~galles/visualization/Algorithms.html}{This other interactive applet} however only shows the process, but it has a wider variety of algorithms.
\end{itemize}
...
% // TODO: Memorizar Uniform Cost Search
...
% // TODO: Memorizar Informed Search
...
% // TODO: Memorizar Simulated Annealing
