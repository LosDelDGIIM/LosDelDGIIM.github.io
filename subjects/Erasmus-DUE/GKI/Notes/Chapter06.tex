...
\begin{enumerate}
    ...
    \item Calculate the Information Gain for each unused feature in the dataset and select the feature with the highest Information Gain to split the data at the current node.
...
\begin{itemize}
    \item It uses the Gain Ratio instead of Information Gain to select the best feature for splitting. The Gain Ratio is calculated as the Information Gain divided by the intrinsic information of the feature, which helps to avoid bias towards features with many values.
