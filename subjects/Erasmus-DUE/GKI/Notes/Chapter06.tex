...
% // TODO: Pensar en los métodos conocidos para Clustering
...
% // TODO: Memorizar desventajas de KMeans
\begin{itemize}
...
% // TODO: Memorizar: Lloyd's Algorithm, MacQueen's Algorithm, X-Means, K-Means++
...
% // TODO: ¿Qué es Hierarchical Clustering? ¿estructura que usan? Dos variantes?
...
% // TODO: Memorizar splitting criteria for Decision Trees
\begin{itemize}
...
This technique uses bootstrapping (explained in page~\pageref{sec:bootstrapping}) to create multiple subsets of the training data, and then trains a separate decision tree on each subset. The final prediction depends on the task:
\begin{itemize}
