...
Classification is a technique used to assign labels to data points based on their features. During the following sections, we will discuss some of the most common classification algorithms, including K-Nearest Neighbors, Decision Trees, and Support Vector Machines.

\subsection{K-Nearest Neighbors}

K-Nearest Neighbors (KNN) is a simple and intuitive algorithm that was already explained in Section~\ref{sec:knn}. As it was stated there, it can also be used for classification tasks, selecting the most common class among the $k$ nearest neighbors of a data point.
