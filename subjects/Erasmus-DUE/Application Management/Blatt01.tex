...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        \item Scrum
        \begin{itemize}
            \item Advantages: Provides a clear framework for managing complex projects, promotes transparency and accountability, and encourages continuous improvement.
