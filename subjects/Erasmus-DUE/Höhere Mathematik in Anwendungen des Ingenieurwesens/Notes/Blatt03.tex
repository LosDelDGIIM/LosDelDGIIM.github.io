...
\begin{ejercicio}[Elektrische Punktladungen im Koordinatensystem]
    ...
    \begin{description}
        ...
        On the other hand, equating the magnitudes of the forces:
        \begin{align*}
            |\vec{F}_{e1}| &= |\vec{F}_{e2}| \Longrightarrow
            k_e \frac{|q_1 e|}{r_{e1}^2} = k_e \frac{|q_2 e|}{r_{e2}^2} \Longrightarrow
            \frac{|q_1|}{r_{e1}^2} = \frac{|q_2|}{r_{e2}^2}
            \Longrightarrow
            \frac{|q_1|}{(x_e - 1)^2 + (y_e - 0.5)^2} = \frac{|q_2|}{x_e^2 + y_e^2}
        \end{align*}

        Therefore, using the relation for $y_e$ in terms of $x_e$, we have the following equation to solve for $x_e$:
        \begin{align*}
            \frac{|q_1|}{(x_e - 1)^2 + \left(\frac{1}{2} x_e - 0.5\right)^2} &= \frac{|q_2|}{x_e^2 + \left(\frac{1}{2} x_e\right)^2}\\
            6\cdot \left(\frac{5}{4} x_e^2\right) &= 2.5 \cdot \left( \frac{5}{4}x_e^2 -2.5 x_e + 1.25 \right)\\
            4.375 x_e^2 + 6.25 x_e - 3.125 &= 0\\
            x_e &= \dfrac{-6.25 \pm \sqrt{(-6.25)^2 - 4\cdot 4.375 \cdot (-3.125)}}{2\cdot 4.375} = \frac{-5\pm 2\sqrt{15}}{7}
        \end{align*}

        Given that $x_e<0$, we take:
        \begin{align*}
            x_e &= -\frac{5+ 2\sqrt{15}}{7} \approx \unit[-1.8208]{m}\\
            y_e &= \frac{1}{2} x_e = -\frac{5+ 2\sqrt{15}}{14} \approx \unit[-0.9104]{m}
        \end{align*}
    \end{description}
