\section{Anwendung komplexer Rechnung}
...
\begin{ejercicio}[Wechselstrommessbrücke]\label{ej:1.5.3}
    ...
    \begin{tikzpicture}
            ...
            \node[shape=rectangle, minimum width=1.34cm, minimum height=0.715cm] at (4.813, 2.625){} node[anchor=north west, align=left, text width=0.952cm, inner sep=6pt] at (4.125, 3){\footnotesize $t=0$};
            ...
            \node[shape=rectangle, minimum width=0.715cm, minimum height=0.715cm] at (6.25, 7.75){} node[anchor=north west, align=left, text width=0.327cm, inner sep=6pt] at (5.875, 8.125){C};
            \node[shape=rectangle, minimum width=0.715cm, minimum height=0.715cm] at (6.25, 0.625){} node[anchor=north west, align=left, text width=0.327cm, inner sep=6pt] at (5.875, 1){D};
        \end{tikzpicture}
    ...
    \begin{enumerate}
        ...
        Let's denote $\ul{U}_{ij}:= \ul{U}_i - \ul{U}_j$ the voltage between nodes $i$ and $j$.
        According to Kirchhoff's laws, we have that:
        \begin{align*}
            \ul{U}_{CA} + \ul{U}_{AB} - \ul{U}_{CB} &= 0 \\
            \ul{U}_{AD} - \ul{U}_{BD} - \ul{U}_{AB} &= 0
        \end{align*}

        In order that the branch A-B is currentless, we need:
        \begin{equation*}
            0 = \ul{I}_5 = \dfrac{\ul{U}_{AB}}{\ul{Z}_5} \iff \ul{U}_{AB} = 0
        \end{equation*}

        Therefore, we have:
        \begin{equation}\label{eq:eq1}
            \ul{U}_{CA} = \ul{U}_{CB} \qquad \ul{U}_{AD} = \ul{U}_{BD}
        \end{equation}

        Using now Kirchhoff's Intensity Law on nodes $A$ and $B$, taking into account that $\ul{I}_5=0$, we have:
        \begin{align*}
            \ul{I}_1 &= \ul{I}_2 \\
            \ul{I}_3 &= \ul{I}_4
        \end{align*}
        ...
        \begin{equation}\label{eq:eq2}
            \dfrac{\ul{U}_{CA}}{\ul{Z}_1} = \dfrac{\ul{U}_{AD}}{\ul{Z}_2} \qquad
            \dfrac{\ul{U}_{CB}}{\ul{Z}_3} = \dfrac{\ul{U}_{BD}}{\ul{Z}_4}
        \end{equation}

        Unifying Equations~\eqref{eq:eq1} and~\eqref{eq:eq2}, we obtain:
        \begin{align*}
            \dfrac{\ul{U}_{CA}}{\ul{Z}_1} = \dfrac{\ul{U}_{AD}}{\ul{Z}_2} \Longrightarrow & \dfrac{\ul{U}_{CA}}{\ul{U}_{AD}} = \dfrac{\ul{Z}_1}{\ul{Z}_2} \\
            \dfrac{\ul{U}_{CA}}{\ul{Z}_3} = \dfrac{\ul{U}_{AD}}{\ul{Z}_4} \Longrightarrow & \dfrac{\ul{U}_{CA}}{\ul{U}_{AD}} = \dfrac{\ul{Z}_3}{\ul{Z}_4}
        \end{align*}

        We should denote that we can divide by $\ul{U}_{AD}$ because if $\ul{U}_{AD}=0$, then $\ul{U}_{BD}=\ul{U}_{AD}=0$ and therefore $\ul{I}_2 = \ul{I}_4 = 0$, which according to the Kirchhoff's Intensity Law implies that $\ul{I}=0$, which would mean that $\ul{U}=0$, which is not the case.

        Therefore, we have the balance condition:
        \begin{equation*}
            \dfrac{\ul{Z}_1}{\ul{Z}_2} = \dfrac{\ul{Z}_3}{\ul{Z}_4} \Longrightarrow \ul{Z}_1\ul{Z}_4 = \ul{Z}_2 \ul{Z}_3
        \end{equation*}
        ...
        \begin{align*}
            \ul{Z}_X &= \ul{Z}_1 = \dfrac{\ul{Z}_2 \ul{Z}_3}{\ul{Z}_4} \\
            &= \dfrac{(10 - 2\jmath)(8-6\jmath)}{5-2\jmath}
            =\\&= \dfrac{492}{29}\Omega - \jmath \cdot \dfrac{244}{29}\Omega
            \approx 16.97 \Omega - \jmath \cdot 8.41 \Omega
        \end{align*}
    \end{enumerate}
...
\begin{ejercicio}[Wechselstromparadoxon]\label{ej:1.5.4}
    ...
    \begin{align*}
        ...
        =\\&\hspace{2cm}=  (R(1 + (R_X\omega C)^2))^2 + R_X^2 + 2R_X\ R(1 + (R_X\omega C)^2) + (R_X^2\omega C)^2
        \Longrightarrow\\
