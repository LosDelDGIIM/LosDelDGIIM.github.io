...
\begin{equation*}
    \vec{e}_i = \dfrac{\dfrac{\partial \vec{r}}{\partial u_i}}{\left\|\dfrac{\partial \vec{r}}{\partial u_i}\right\|}
\end{equation*}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw[dashed, blue!70!black, thick] (0,0) -- (P) node[midway, sloped, above, font=\small] {$\rho$};
