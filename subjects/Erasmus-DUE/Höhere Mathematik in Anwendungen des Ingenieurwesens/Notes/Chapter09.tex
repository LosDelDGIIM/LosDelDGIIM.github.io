...
\begin{definicion}[Fourier Series]
    ...
    \[
    S_f(x) =  \frac{a_0}{2} + \sum_{n\geq 1}\left[a_n \cos\left(\omega_n x\right) + b_n \sin\left(\omega_n x\right)\right]
    \]
...
\begin{prop}
    ...
    \begin{itemize}
        ...
        \[
            S_f(x) = \frac{a_0}{2} + \sum_{n\geq 1} a_n \cos\left(\omega_n x\right)
        \]
        \item If $f$ is an odd function, then $a_n = 0$ for all $n\geq 0$, and the Fourier series reduces to a sine series:
        \[
            S_f(x) = \sum_{n\geq 1} b_n \sin\left(\omega_n x\right)
        \]
    \end{itemize}
\end{prop}
...
\begin{align*}
    S_f(x) &= \frac{a_0}{2} + \sum_{n\geq 1} \left[\dfrac{a_n}{2}\cdot \left(e^{i\omega_n x} + e^{-i\omega_n x}\right) - \dfrac{b_n i}{2}\cdot \left(e^{i\omega_n x} - e^{-i\omega_n x}\right)\right]
\end{align*}
