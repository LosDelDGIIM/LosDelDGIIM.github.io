...
\begin{equation*}
    \dfrac{\partial f}{\partial v}(x_0) = L(v)
\end{equation*}
\begin{observacion}
...
\begin{itemize}
    \item In 2D, the area of a region $R\subset \mathbb{R}^2$ below a continuos function $f:[a, b] \to \mathbb{R}^+_0$ is the following integral:
    \[
