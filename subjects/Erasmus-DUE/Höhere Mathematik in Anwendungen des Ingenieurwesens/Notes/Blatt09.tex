...
\Func{\varphi_1}{[0,2\pi]}{\bb{R}^3}{t}{(t\cos(t), t\sin(t), t)}
    ...
    We then realize that $\varphi$ is differentiable, and given that the third component is constant and non-zero, we can conclude that the parameterization is regular. Therefore, in order to compute the norm of the derivative, we have:
    \begin{align*}
