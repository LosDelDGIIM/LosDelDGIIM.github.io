...
\begin{itemize}
    ...
    \item It required a clear line of sight between the fixed points and $P$, as the sound waves can be reflected or absorbed by objects in the environment, which can lead to inaccurate measurements.
