...
This solution solves two problems: the surface parameterization and the memory usage. It should be noted that this solution is notonly for shell texture, but it can be applied to any volume texture. This approach has the following steps:
\begin{enumerate}
