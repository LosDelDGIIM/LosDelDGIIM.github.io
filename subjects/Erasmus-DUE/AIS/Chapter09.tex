...
% // TODO: Memorizar Rescale-and-add
\begin{equation}
    H(x, y) = \sum_{i=1}^{n} \frac{1}{2^{i-1}} \cdot F\left( \frac{1}{2^{n-i}} x, \frac{1}{2^{n-i}}\cdot y \right)
...
\begin{equation}
    H(x, y) = \sum_{i=1}^{o} \frac{1}{2}\cdot r^{i-1} \cdot F\left( \frac{1}{l^{o-i}} x, \frac{1}{l^{o-i}} y \right)
