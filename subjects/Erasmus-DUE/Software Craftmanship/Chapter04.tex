...
It is based on a concept named ``Circle of Life'', which represents the practices that should be taken, from a bigger aspect (the whole project) to a smaller aspect (the code itself).
...
\begin{itemize}
    ...
    How much time will it take to do a task should be estimated three times:
    \begin{itemize}
