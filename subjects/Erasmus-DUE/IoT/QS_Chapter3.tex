...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        In this case:
        \begin{itemize}
            \item $C1$ would receive the message published by $C4$, as its topic filter, which is \texttt{home/thirdfloor/+/temp}, matches the topic of the message published by $C4$.
