...
An IoT system consists of all the HW and SW components that are required to implement an IoT application. The components of an IoT system can be categorized into three main groups: devices, communication, and data processing. In order to reduce the complexity of an IoT system, developpers tend to reuse the same components across different applications, and here is where the concept of \emph{IoT platforms} comes into play.
