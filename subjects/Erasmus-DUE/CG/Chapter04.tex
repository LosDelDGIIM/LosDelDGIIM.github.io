...
\begin{itemize}
    ...
    \item The magnetic field wave, which also oscillates in a plane perpendicular to the direction of propagation, but perpendicular to the electric field wave.
\end{itemize}
