...
\begin{itemize}
    \item \ul{Hemicube method}: it is a method that aproximates the form factor between a differential patch $dA_i$ and a patch $A_j$ by projecting the patch $A_j$ onto a hemispherical sphere centered at the point $x$ of the patch $dA_i$.
    \begin{itemize}
...
\begin{enumerate}
    \item The scene is divided into small patches with finite area and constant properties.
