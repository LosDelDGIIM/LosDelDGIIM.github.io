...
The cost function is used to determine the optimal position and direction of the dividing plane in both KD and BSP trees. An heuristic called \ul{Surface Area Heuristic (SAH)} is commonly used for this purpose.
