    ...
    \begin{enumerate}
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}
                ...
                \addplot[domain=0:11.1, samples=100, thick, blue] {0.09/(1-x*0.09) + 0.16/(1-x*0.08)};
                \addlegendentry{$R_0(\lm_0)$}
                \addplot[domain=0:15, samples=100, thick, red] {0.25};
                \addlegendentry{$R_0^{\text{min}}=0.25$}
                \addplot[thick, teal] coordinates {(11.1111,0) (11.1111,12)};
                \addlegendentry{$X_0^{\text{max}}=11.1111$}
                \end{axis}
            \end{tikzpicture}
