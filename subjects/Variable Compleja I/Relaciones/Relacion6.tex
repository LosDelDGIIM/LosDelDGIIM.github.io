...
\begin{ejercicio}
    ...
    \begin{align*}
        ...
        = \int_{-\pi}^{\pi} \frac{i-2i^2}{{\cos^2t + (2+\sen t)^2}}dt
        =\\&= \int_{-\pi}^{\pi} \frac{2+i}{{\cos^2t + 4+\sen^2t+4\sen t}}dt
        = \int_{-\pi}^{\pi} \frac{2+i}{{5+4\sen t}}dt
        =\\&= \left(2\int_{-\pi}^{\pi} \frac{1}{{5+4\sen t}}dt\right) + i\left(\int_{-\pi}^{\pi} \frac{1}{{5+4\sen t}}dt\right)
    \end{align*}

    Calcular dicha integral no es directo, por lo que vamos a intentar evitarlo. Tenemmos que:
    \begin{align*}
        ...
        \\&\iff \int_{\sigma} \frac{dz}{z+i} = 2\pi i
    \end{align*}

    Igualando parte real y parte imaginaria, tenemos que:
    \begin{align*}
        0 &= 2\int_{-\pi}^{\pi} \frac{1}{{5+4\sen t}}dt\\
        2\pi &= \int_{-\pi}^{\pi} \frac{1}{{5+4\sen t}}dt
    \end{align*}
