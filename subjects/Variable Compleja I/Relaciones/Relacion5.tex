...
\begin{ejercicio}
    ...
    Como buscamos una función holomorfa, tan solo usaremos en la construcción funciones holomorfas. Dado $z\in \Omega$, veamos que $z^2-1\in \bb{C}^*\setminus\bb{R}^+$. Supongamos que $z^2-1\in \bb{R}^+_0$. Entonces, $z^2\in \bb{R}^+$, y por tanto:
    \begin{equation*}
