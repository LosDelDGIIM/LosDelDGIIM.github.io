    ...
    \begin{enumerate}
        ...
        \begin{description}
            ...
            \item [Opción 2: Sin calcular los valores de las constantes.]~\\
                ...
                \begin{enumerate}
                    \item Para la primera, tenemos que:
                        \begin{equation*}
                            \int_{C(0,r)}\dfrac{dz}{z} = \int_{-\pi}^{\pi} \dfrac{ire^{it}}{re^{it}}~dt  = \int_{-\pi}^{\pi} i~dt  = 2\pi i
                        \end{equation*}
                    \item Para la segunda: 
                        \begin{itemize}
                            \item Si $r < 2$, tenemos que $|-2i| = 2 > r$, y por el Ejercicio~\ref{ej:7.1} sabemos que la integral es $0$
                            \item Si $r > 2$, tenemos que $|-2i| = 2 < r$, y por el Lema previo a la Fórmula de Cauchy para la circunferencia, sabemos que la integral vale $2\pi i$.
                        \end{itemize}
                    \item Para la tercera se da la misma situación que para la segunda integral.
                \end{enumerate}
