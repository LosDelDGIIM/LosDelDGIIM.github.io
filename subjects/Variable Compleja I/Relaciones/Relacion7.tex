...
\begin{ejercicio}[Versión más general de la fórmula de Cauchy]\label{ej:7.2}
    ...
    \Func{g}{\ol{D}(a,R)\setminus D(a,|z-a|)}{\bb{C}}{w}{\dfrac{f(w)}{w-z}}

    Definimos además la parametrización $\varphi_n$ de $C(a,r_n)$ como:
    \Func{\varphi_n}{[-\pi, \pi]}{C(a,r_n)^*}{t}{a+r_n e^{it}}

    Además, la parametrización $\varphi$ de $C(a,R)$ la definimos como:
    \Func{\varphi}{[-\pi, \pi]}{C(a,R)^*}{t}{a+R e^{it}}
    ...
    \Func{h}{[r_1,R]\times [-\pi,\pi]}{\bb{C}}{(r,t)}{g(a+re^{it})\cdot ire^{it}}
