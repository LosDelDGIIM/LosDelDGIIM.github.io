...
\begin{document}
    ...
    \begin{ejercicio}[2 puntos]
        Sea $f$ una función entera verificando que existen constantes $R, \epsilon > 0$ tales que
        \[ |f(z)| \ge \epsilon, \text{ si } |z| \ge R. \]
    ...
    \begin{ejercicio}[2 puntos]
        ...
        \[\exists n_2 \in \mathbb{N} : \; \forall m \geq n_2 \Rightarrow |f(z_m)| < \epsilon\]

        Tomando $n=\max\{n_1,n_2\}$ vemos que $\forall m \geq n : \; |f(z_m)| < \epsilon \wedge |z_m| \geq R$\\
        ...
        Por el Teorema fundamental del Álgebra: $\exists z\in \mathbb{C} : \; f(z) = 0$, aunque realmente existirán tantos como el grado de f contando multiplicidad. Como $f(z)=0 \Rightarrow |f(z)| = 0 < \epsilon$, tenemos que $|z| < R \iff z\in D(0,R)$\\
    ...
    \begin{ejercicio}[1 punto por cada apartado]
        ...
        \begin{enumerate}
            \item Sea $f \in \mathcal{H}(\mathbb{C})$ verificando $f\left(\nicefrac{1}{n}\right) = \nicefrac{1}{n^2}$ para cada $n \in \mathbb{N}$. Calcule $f$.
                ...
                \[f(z) = z^3 \;\forall z\in A \Longrightarrow f(z) = z^3 \qquad \forall z \in \mathbb{C}\]
