...
int main(){
	...
	// Obtiene la circunferencia centrada en el rectángulo

	Circunferencia circf(rect.ObtenerCentro(), RADIO_INIC);

	// Obtiene la menor circf de área mayor que la del rectángulo
	...
	cout << "La menor circunferencia centrada en el rectangulo con mayor" 
		 << " superficie que este: " << endl;

	cout << "Tendra de centro: " << circf.ObtenerCentro().ToString() << endl;
	cout << "Y de radio: " << circf.ObtenerRadio() << endl;
