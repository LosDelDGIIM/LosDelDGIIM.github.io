...
\begin{align*}
    L^b_a(\alpha,P) &= |\alpha(t_1) - \alpha(t_0)| + \ldots + |\alpha(t_n) - \alpha(t_{n-1})| \\
                    ...
                    &\leq \int_{t_0}^{t_1} |\alpha'(t)|~dt  + \ldots + \int_{t_{n-1}}^{t_n} |\alpha'(t)|~dt  \\
