...
\begin{ejercicio}
    ...
    \end{equation*}
    Puede probarse que $\lm$ es diferenciable a partir de esta expresión (hágase de forma similar al siguiente apartado), con lo que bien tenemos $\lm(s)> 0 $ o $\lm(s)<0$ para todo $s\in I$. Ahora para $s_0\in I$ tenemos:
    \begin{equation*}
...
\begin{equation*}
    \boxed{N'(s) = -k(s)T(s)}
\end{equation*}
Estas dos ecuaciones que hemos destacado reciben el nombre de ``ecuaciones de Frenet''.  % // TODO: MEncionar el signo de la curva: >0 volante izqda, <0 volante dcha. Observar que curvatura solo se define para curvas p.p.a.
