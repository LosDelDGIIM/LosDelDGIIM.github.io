...
\begin{ejemplo}
    ...
    \begin{enumerate}
        ...
        \item Sea $\eta:I\to \mathbb{R}^2$ con $I = \left]-1,+\infty\right[$ dada por:
            ...
            \end{equation*}
            Demostrar que $\eta$ es inyectiva y que $\eta'(t) \neq 0 \quad \forall t\in I$. ¿Es $I$ homeomorfo a $\tr \eta$?

            Vemos que $I$ no es homeomorfo a $\tr \eta$ (coger el entorno correspondiente).
    \end{enumerate}
\end{ejemplo}
