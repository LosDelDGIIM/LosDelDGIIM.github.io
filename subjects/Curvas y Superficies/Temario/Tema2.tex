...
\begin{ejemplo}
    ...
    \begin{itemize}
        ...
        \item Ahora, para $X^{-1}:X(U)\to U$ sale de una superficie y $U\subset \mathbb{R}^2$ abierto, por lo que tenemos que comprobar diferenciabilidad en el sentido $a)$, por lo que para toda parametrización necesitamos comprobar si al componerla con $X^{-1}$ es diferenciable en el sentido del análisis.
