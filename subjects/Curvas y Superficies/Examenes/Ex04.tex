...
\begin{document}
    ...
    \begin{ejercicio}~
        \begin{enumerate}
            ...
            Consideramos $I = \left]0,1 \right[$. Por definición de $\alpha$ p.p.a, tenemos que $$|\alpha'(t)| = 1 \quad \forall t \in I$$
            Por otro lado, como la traza de $\alpha$ está contenida en $S^2(0,r)$, por definición de esta esfera
            \begin{equation}\label{eq:ec1}
                |\alpha(t)|^2 = r^2 \quad \forall t \in I
            \end{equation}
            ...
            $$k_\alpha(t) = |\alpha''(t)|$$
            y es inmediato que
            $$\boxed{k_\alpha(t) = |\alpha''(t)| \geq \dfrac{1}{r} \quad \forall t \in I}$$
            ...
            Nuevamente consideramos $I = \left]0,1 \right[$. Por definición de $\gamma$, está claro que $\gamma'(t) = \beta''(t)$. 
            ...
            sí que estará p.p.a. (con $\gamma$ no lo podemos demostrar por falta de hipótesis). Fijado $a \in 
            ...
            $k_\gamma(t) = k_{\tilde{\gamma}}(S_a(t))$, deducimos lo que se pide
    ...
    \begin{ejercicio}
        ...
        \begin{enumerate}
            ...
            $$e = 0, \quad f = \dfrac{\tan v}{\sqrt{2u^2 + \tan^2v}}, \quad g = \dfrac{u^2 - u\sec^2 v}{\sqrt{2u^2 + \tan^2v}}, \quad E = 2, \quad F = - \tan v, \quad G = u^2 + \tan^2 v$$
            nos queda
            ...
            Recíprocamente, si $(x,y,0) \in \R^3$ con $x >0$, tomamos los valores que ya comprobamos en la demostración 
    ...
    \begin{ejercicio}
        ...
        \begin{enumerate}
            ...
            \prodesc{X_v}{X} = 0$$
            Es decir, $X$ es ortogonal a $X_u$ y a $X_v$. Además, sabemos que los coeficientes de la primera forma fundamental son
            $$\prodesc{X_u}{X_u} = E = 3, \quad \prodesc{X_u}{X_v} = F = 0, \quad \prodesc{X_v}{X_v} = G = 3$$
            Derivando (\ref{eq:ec4}) respecto de $u$
            $$\prodesc{X_{uu}}{X} + \prodesc{X_u}{X_u} = 0 \Longrightarrow \prodesc{X_{uu}}{X} = -3$$
            Como $E$ es constante, derivando su expresión respecto de $u$ se deducimos que
            $$2\prodesc{X_{uu}}{X_u} = 0 \Longrightarrow \prodesc{X_{uu}}{X_u} = 0$$
            Derivando esta misma expresión respecto de $v$:
            \begin{equation}\label{eq:ec5}
                2 \prodesc{X_{uv}}{X_u} = 0 \Longrightarrow \prodesc{X_{uv}}{X_u} = 0
            \end{equation}
            Ahora, derivando la expresión de $F$ respecto de $u$ se tiene que
            $$\prodesc{X_{uu}}{X_v} + \prodesc{X_{u}}{X_{uv}} = 0 \stackrel{(\ref{eq:ec5})}{\Longrightarrow}
            \prodesc{X_{uu}}{X_v} = 0$$
            En resumen, tenemos que
            $$\prodesc{X_{uu}}{X} = -3, \quad \prodesc{X_{uu}}{X_u} = 0, \quad \prodesc{X_{uu}}{X_{v}} = 0$$
            Por tanto, como $B = \{X, X_u, X_v\}$ es una base de $\R^3$ (ya que tenemos 3 vectores linealmente independientes
            (todos ellos ortogonales entre sí) no nulos, pues $|X|^2 = 1$, $|X_u|^2 = |X_v|^2 = 3$), está claro que
            ...
            y como $F=0$,
            $$\prodesc{X_{uv}}{X} = 0$$
            Nuevamente, como $E$ y $G$ son constantes, derivando sus expresiones respecto de $v$, obtenemos
            $$\prodesc{X_{uv}}{X_u} = 0, \quad \prodesc{X_{uv}}{X_v} = 0$$
            y de nuevo en coordenadas de la base $B$ tenemos que $X_{uv} = 0$. Entonces $X_{uuv} = 0$, pero derivando (\ref{eq:ec6})
