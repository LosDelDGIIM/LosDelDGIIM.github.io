...
\end{document}
    ...
    Se pueden encontrar en \href{https://github.com/LosDelDGIIM/LosDelDGIIM.github.io/tree/main/subjects/_plantillas}{\color{blue}\ul{la siguiente carpeta}}. Hay dos tipos portadas disponibles:
    \begin{description}
