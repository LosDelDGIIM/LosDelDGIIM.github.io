...
\begin{ejercicio}
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \tikz[remember picture] \draw[overlay, red] ([xshift=0.25em]pic cs:Ej4col2Start) -- (pic cs:Ej4col2End);
        \tikz[remember picture] \draw[overlay, teal] ([xshift=0.25em]pic cs:Ej4col4Start) -- (pic cs:Ej4col4End);
        \tikz[remember picture] \draw[overlay, blue] ([xshift=0.25em]pic cs:Ej4col6Start) -- (pic cs:Ej4col6End);
        \tikz[remember picture] \draw[overlay, purple] ([xshift=0.25em]pic cs:Ej4col8Start) -- ([xshift=0.25em]pic cs:Ej4col8End);
        \tikz[remember picture] \draw[overlay, orange] ([xshift=0.5em]pic cs:Ej4col10Start) -- (pic cs:Ej4col10End);
        \tikz[remember picture] \draw[overlay, green] ([xshift=0.5em]pic cs:Ej4col12Start) -- ([xshift=0.25em]pic cs:Ej4col12End);
    \end{table}
