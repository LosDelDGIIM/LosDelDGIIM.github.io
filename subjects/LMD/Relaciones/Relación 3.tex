    ...
    \begin{proof}
        ...
        \begin{description}
            ...
            \item [$\supseteq$)] Sea $\gamma\in \Con(\Gamma,\alpha)\cap \Con(\Gamma,\beta)$, es decir:
                ...
                Tenemos que demostrar que $\gamma\in \Con(\Gamma,\alpha\lor\beta)$, es decir, que $\Gamma\cup\{\alpha\lor\beta\}\models \gamma$. Demostremos antes el siguiente resultdado.\\
                ...
                Entonces, como $\Gamma\cup \{\alpha\}\models \gamma$, entonces $v(\gamma)=1$, por lo que:
