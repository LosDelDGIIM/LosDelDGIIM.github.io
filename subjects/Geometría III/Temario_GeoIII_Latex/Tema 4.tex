...
\end{proof}
\end{comment}
TERMINAR % // TODO: Terminar sección determinación de una proyectividad
...
\subsection{Proyectivización de subespacios afines} %// TODO: Dar formalidad a proyectivización de subespacios afines
...
Sean ecuaciones paramétricas de $S$ en la base $\cc{B}$ las siguientes:
\begin{equation*}
    \left(\begin{array}{c}
        x_1 \\ \vdots \\ x_n
    \end{array}\right)
