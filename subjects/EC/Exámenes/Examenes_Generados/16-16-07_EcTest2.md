...
-   (x) La realización nanoprogramada de una unidad de control es más rápida que la microprogramada.
...
-   (x) ninguna de las otras opciones
...
-   ( ) 1K bits
-   ( ) 1703936 bits
-   (x) Ninguna respuesta es correcta
