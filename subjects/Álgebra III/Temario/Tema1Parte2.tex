...
\begin{definicion}
    ...
    \end{figure}
    \noindent
    Si $F\leq K$ es una extensión de cuerpos y $\sigma:F\to K$ es la aplicación inclusión, diremos simplemente que $Ex(\tau,\sigma)$ es el conjunto de las extensiones de $\tau$.
\end{definicion}
