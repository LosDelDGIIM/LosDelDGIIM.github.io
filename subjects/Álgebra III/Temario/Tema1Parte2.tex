...
\begin{ejemplo}
    ...
    \noindent
    Es decir, nos preguntamos cuántos homomorfismos de cuerpos $\eta:\mathbb{Q}\left(\sqrt[3]{2}\right)\to \mathbb{C}$ hay. Para ello, reformularemos el problema en calcular un cierto conjunto de extensiones. Si consideramos las dos inclusiones de $\mathbb{Q}$ en $\mathbb{C}$ y en $\mathbb{Q}\left(\sqrt[3]{2}\right)$, tenemos:
    \begin{figure}[H]
        \centering
        \shorthandoff{""}
        \begin{tikzcd}
            \mathbb{Q} \arrow[rd, "\iota"] \arrow[r, "\iota"] & \mathbb{C}                                   \\
                                                             & {\mathbb{Q}\left(\sqrt[3]{2}\right)} \arrow[u, "\eta"']
        \end{tikzcd}
        \shorthandon{""}
    \end{figure}
    \noindent
    Y lo que queremos hacer es calcular los elementos del conjunto $Ex(\iota,\iota)$. Sabemos que:
    \begin{equation*}
        Irr(\sqrt[3]{2},\mathbb{Q}) = x^3-2
    \end{equation*}
    ...
    \begin{equation*}
        Ex(\iota,\iota) = \{\eta_0,\eta_1,\eta_2\}
    \end{equation*}
...
\begin{ejemplo}
    ...
    \noindent
    Sea $K = \mathbb{Q}\left(\sqrt[3]{2},w\right)$ con $w$ una raíz cúbica primitiva de la unidad, si queremos calcular todos los homomorfismos de $\mathbb{Q}$ en $K$, lo que haremos será considerar las respectivas aplicaciones de inclusión $\tau,\sigma_1$ y $\sigma_2$, con lo que tenemos:
    \begin{figure}[H]
        \centering
        \shorthandoff{""}
        \begin{tikzcd}
...
\section{Clasificación de los cuerpos finitos} % // TODO: PASAR A LIMPIO A PARTIR DE AQUI
