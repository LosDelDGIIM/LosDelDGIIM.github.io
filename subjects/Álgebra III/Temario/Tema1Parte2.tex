...
\begin{ejemplo}
    ...
    \end{equation*}
    Como cada uno de los $\eta_j$ es un homomorfismo definido sobre $\mathbb{Q}\left(\sqrt[3]{2}\right)$ con base $\left\{1,\sqrt[3]{2}\right\}$, es suficiente definirlos sobre 1 y sobre $\sqrt[3]{2}$, pero como $\eta_j$ tiene que ser un homomorfimo de cuerpos, ha de cumplirse $\eta_j(1)=1$, por lo que basta definirlo sobre $\sqrt[3]{2}$. Como ejemplo de esto último, observemos que podemos calcular:
    \begin{equation*}
...
\begin{ejercicio}
    ...
    \begin{description}
        ...
        \item [$\Longleftarrow )$] Tenemos las extensiones $F\leq F(\beta)\leq F(\alpha)$. Como $\beta$ es algebraico sobre $F$ tenemos que la primera extensión es finita. Si observamos ahora que:
            \begin{equation*}
                \beta = 1 + \alpha^2 + \alpha^5 \quad\Longleftrightarrow\quad 1-\beta + \alpha^2 + \alpha^5
            \end{equation*}
...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item Para $\alpha = \sqrt{3}-\sqrt[4]{3}$. 
            ...
            \begin{equation*}
                \sqrt[4]{3} = \alpha-\sqrt{3} \quad\Longrightarrow\quad \sqrt{3} = \alpha^2 + 3 - 2\alpha \sqrt{3} \quad\Longleftrightarrow\quad \sqrt{3}(1+2\alpha) = \alpha^2 + 3
            \end{equation*}
            ...
            \begin{equation*}
                f = x^4 -6x^2 -12x +6
            \end{equation*}
            y vemos que $f$ es irreducible por Eisenstein para $p=2$, de donde tenemos que $f = \Irr(\alpha,\mathbb{Q})$.
        \item Para $\alpha = \sqrt[3]{2}+\sqrt[3]{4}$. 
            ...
            \begin{equation*}
                f = x^3-6x-6
            \end{equation*}
            que es irreducible por Eisenstein para $p=2$, luego $\Irr(\alpha,\mathbb{Q}) = f$.
    \end{enumerate}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \end{equation*}
    \begin{enumerate}[label=\alph*)]
        \item Para $E = \mathbb{Q}\left(\sqrt{6},i\right)$.  % // TODO: Poner base
        ...
        \item Para $E=\mathbb{Q}\left(\sqrt{18},\sqrt[3]{4}\right)$. % // TODO: Poner base

            Tenemos por el Lema de la Torre que:
            \begin{equation*}
                [E:\mathbb{Q}] = \left[E:\mathbb{Q}\left(\sqrt[3]{4}\right)\right]\left[\mathbb{Q}\left(\sqrt[3]{4}\right):\mathbb{Q}\right]
            \end{equation*}
            con:
            \begin{itemize}
                \item $\left[\mathbb{Q}\left(\sqrt[3]{4}\right):\mathbb{Q}\right] = 3$, ya que $\Irr\left(\sqrt[3]{4},\mathbb{Q}\right) = x^3-4$, es irreducible por ser de grado 3 y no tener raíces en $\mathbb{Q}$, ya que sus posibles raíces son:
                    \begin{equation*}
                        Div(4) = \{\pm1, \pm2, \pm4\}
                    \end{equation*}
                    y ninguna de ellas es raíz:
                    \begin{gather*}
                        ...
                        {(-4)}^{3}-4 = -68 \neq 0
                    \end{gather*}
                \item $\left[E:\mathbb{Q}\left(\sqrt[3]{4}\right)\right]\leq 2$, ya que $x^2-18$ es un polinomio mónico de grado 2 del que $\sqrt{18}$ es raíz, pero no sabemos si es irreducible sobre $\mathbb{Q}\left(\sqrt[3]{4}\right)$, por lo que podría ser $\left[E:\mathbb{Q}\left(\sqrt[3]{4}\right)\right] = 1$.
            \end{itemize}
            ...
            \begin{equation*}
                \left[E:\mathbb{Q}\right] = \left[E:\mathbb{Q}\left(\sqrt{18}\right)\right]\left[\mathbb{Q}\left(\sqrt{18}\right):\mathbb{Q}\right]
            \end{equation*}
            con:
            \begin{itemize}
                \item $\left[\mathbb{Q}\left(\sqrt{18}\right):\mathbb{Q}\right] = 2$, ya que $\Irr\left(\sqrt{18},\mathbb{Q}\right) = x^2-18$, es irreducible por Eisenstein para $p=2$.
                \item $\left[E:\mathbb{Q}\left(\sqrt{18}\right)\right] \leq 3$, ya que $x^3-4$ es un polinomio mónico de gardo 3 del que $\sqrt[3]{4}$ es raíz, pero al igual que antes no sabemos si es irreducible o no.
            \end{itemize}
...
\begin{ejercicio}
    ...
    \begin{align*}
        (1+\alpha+\alpha^2)(a+b\alpha+c\alpha^2) &= a + b\alpha + c\alpha^2 + a\alpha + b\alpha^2 + c\alpha^3 + a\alpha^2 + b\alpha^3 + c\alpha^4 \\
                                                 &= a + \alpha(a+b) + \alpha^2(a+b+c) + \alpha^3 (b+c) + c\alpha^4
    \end{align*}
    Usamos ahora que $\alpha^3 + 3\alpha + 1 = 0$, con lo que:
    \begin{equation*}
        \alpha^3 = -3\alpha - 1, \qquad \alpha^4 = \alpha \alpha^3 = -3\alpha^2 - \alpha
    \end{equation*}
    de aquí tenemos que:
    \begin{align*}
        (1+\alpha+\alpha^2)(a+b\alpha+c\alpha^2) &= a + \alpha(a+b) + \alpha^2 (a+b+c) + (-3\alpha-1)(b+c) - 3c\alpha^2 - c\alpha \\
                                                 &= (a-b-c) + \alpha(a-2b-4c) + \alpha^2 (a+b-2c)
    \end{align*}
    ...
    \begin{equation*}
        a = \frac{8}{7}, \qquad b = \frac{-2}{7},\qquad c = \frac{3}{7}
    \end{equation*}
    Seguimos calculando las coordenadas del elemento enunciado:
    \begin{align*}
        (1+\alpha){(1+\alpha+\alpha^2)}^{-1} &= (1+\alpha)(a+b\alpha + c\alpha^2) \\
                                             &= a + b\alpha + c\alpha^2 + a \alpha + b\alpha^2 + c\alpha^3 \\
                                             &= a + \alpha(a+b) + \alpha^2(b+c) + c\alpha^3 \\
                                             &= a + \alpha(a+b) + \alpha^2(b+c) + c(-3\alpha-1) \\
                                             &= (a-c) + \alpha(a+b-3c) + \alpha^2 (b+c)
    \end{align*}
    Por lo que obtenemos que sus coordenadas son:
    \begin{align*}
        a-c = \frac{8}{7}-\frac{3}{7} &= \frac{5}{7} \\
        a+b-3c = \frac{8}{7} - \frac{2}{7} - \frac{9}{7} &= \frac{-3}{7} \\
        b+c = \frac{-2}{7} + \frac{3}{7} &= \frac{1}{7}
    \end{align*}
\end{ejercicio}

\begin{ejercicio} % // TODO: No entiendo este puto ejercicio
    ...
    \noindent
    Cuando decimos que $\bb{F}_4 = \bb{F}_2(a)$ con $a^2+a+1=0$ decimos que como $x^2+x+1\in \bb{F}_2[x]$ es irreducible tenemos entonces que existe un homomorfismo $\sigma:\bb{F}_2\to K$ y $a\in K$ de forma que $K = \sigma(\bb{F}_2)(a)$ (notemos que $\sigma(\bb{F}_2) = \bb{F}_2$ para cualquier homomorfismo de cuerpos $\sigma:\bb{F}_2\to E$) y $a^2+a+1 = 0$.\\
    ...
    \end{equation*}
    tenemos entonces que $[K:\bb{F}_2] = 4$. Como $\bb{F}_2$ tiene 2 elementos, vemos entonces que $|K| = 2^4 = 16$, llamamos $\bb{F}_{16} = K$.\\
    ...
    \noindent
    Para ello, como $\Irr(a,\bb{F}_2) = x^2+x+1\in \bb{F}_2[x]$ y $\bb{F}_4 = \bb{F}_2(a)$, tendremos tantas extensiones de la inclusión como raíces tenga el polinomio $x^2+x+1$ en $\bb{F}_2(b)$.\\
