...
\begin{ejercicio} % 55
    ...
    \noindent
    Veamos que $f$ es irreducible, puesto que es de grado 3 y sus únicas posibles raíces en $\mathbb{Q}$ son $\pm 1$, y no lo son; luego $f$ es irreducible. De aquí deducimos que $K$, el cuerpo de descomposición de $f$, es un subgrupo transitivo de $S_3$, luego es $A_3$ o $S_3$.\\
