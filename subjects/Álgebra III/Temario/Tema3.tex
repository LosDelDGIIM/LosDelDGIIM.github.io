...
\begin{ejemplo}
    ...
    \noindent
    Este diagrama es conmutativo, ya que si tomamos $\sigma\in G$ y lo vemos en $\Aut_F(E)$, tenemos entonces que este permutará (a través de la inyección canónica) las raíces $\beta_i$. Por otra parte, si vemos $\sigma$ sobre $\Sim(\alpha_1,\ldots,\alpha_4)$ a través de su inyección canónica, obtenemos que $\sigma$ sabe actuar sobre $\alpha_1,\ldots,\alpha_4$, permutándolas, y si observamos la definición de los $\beta_i$, por ejemplo, que:
    \begin{equation*}
        \beta_1 = \alpha_1 \alpha_2 + \alpha_3 \alpha_4
    \end{equation*}
    ...
    \end{equation*}
    donde usamos que $\iota$ es inyectiva, así como que $V$ es el núcleo de $S$. Si pensamos en identificar $G$ con un subgrupo de $\Sim(\alpha_1,\ldots,\alpha_4)$; obtenemos que $\ker (S\circ \iota) = V\cap G$, y tenemos así que:
    \begin{equation*}
