...
\begin{ejemplo}
    ...
    \end{equation*}
    En esta última factorización vemos que $\bb{F}_{16}$ puede presentarse de 3 formas distintas sobre $\bb{F}_2$, tomando $\bb{F}_{16} = \bb{F}_2(a)$ con $a$ raíz de cualquiera de los 3 polinomios de grado 3. Para cada polinomio tendremos una presentación posible.
\end{ejemplo}
