...
\begin{ejemplo}
    ...
    \end{equation*}
    Y sabemos que son todas porque el grupo de la derecha tiene $6$ elementos y el de la izquierda 24; con lo que $\ker S = V$ ($r$ es la restricción, viene del teorema que habla sobre subgrupos normales). Donde $N$ es el núcleo, ya que $N$ es $\Aut_E(K)$.\\
