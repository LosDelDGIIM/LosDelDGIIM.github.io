...
\noindent
Recordemos además que si una sucesión de funciones $\{f_n\}$ es uniformemente de Cauchy entonces $\{f_n\}$ converge uniformemente a una función $f$.\\
...
\begin{ejercicio}
    ...
    \end{equation*}
    por ser $\tau$ estrictamente creciente. Ahora, si consideramos la aplicación $\delta:\mathbb{N}\to \mathbb{N}$ dada por la correspondencia $n\longmapsto m_n$ acabamos de probar que $\delta$ es estrictamente creciente, así como que $\tau(\delta(n)) = \tau(m_n) = \sigma(n)$ para cada $n\in \mathbb{N}$ por definición de $\delta$, con lo que:
    \begin{equation*}
