...
\begin{teo}[Ascoli-Arzelà]\label{teo:Ascoli-A}
    ...
    \begin{proof} % // TODO: Repasar prueba
        ...
        \begin{enumerate}
            \item Primero buscaremos $D\subset I$ denso y una parcial $\{f_{\sigma(n)}\}$ de forma que $\{f_{\sigma(n)}(t)\}$ es convergente $\forall t\in D$.
                ...
                \begin{equation*}
                    D = \{t_n : n\geq 0\}
                \end{equation*}
                Tenemos la sucesión $\{f_n(t_0)\}$, que por hipótesis es una sucesión acotada en $\mathbb{R}^d$. Así, existe $\sigma_0:\mathbb{N}\to \mathbb{N}$ estrictamente creciente de forma que:
                \begin{equation*}
            ...
            \item Ahora vamos a ver que $\{f_{\sigma(n)}\}$ es uniformemente de Cauchy. Para ello, dado $\varepsilon>0$, buscamos $N\in \mathbb{N}$ de forma que si $n,m\geq N$ obtengamos que:
                \begin{equation*}
                    \|f_{\sigma(n)}(t) - f_{\sigma(m)}(t)\| < \varepsilon \qquad \forall t\in I
                \end{equation*}
                Fijado $\varepsilon>0$, como $\{f_n\}$ es equicontinua, existe $\delta>0$ tal que si $t,s\in I$ con $|t-s|<\delta$ tenemos entonces que:
                \begin{equation*}
                    \|f_{\sigma(n)}(t) - f_{\sigma(n)}(s)\| < \frac{\varepsilon}{3} \qquad \forall n\geq 0
                \end{equation*}
                Podemos observar que para cualquier $r>0$ tenemos que:
                \begin{equation*}
                    \overline{I} \subset \bigcup_{t\in D} B(t,r)
                \end{equation*}
                Y como $\overline{I}$ es compacto (por ser $I$ acotado) podemos extraer un subrecubrimiento finito del mismo. Si tomamos $r=\delta$, esto nos permite obtener $D_\delta\subset D$ finito tal que para todo $t\in I$ existe $s\in D_\delta$ con $|t-s|<\delta$.

                Ahora, tenemos que $\{f_{\sigma(n)}(s)\}$ es de Cauchy para cada $s\in D_\delta$, por ser convergente para $s\in D$, de donde para $\nicefrac{\varepsilon}{3}$ existe $N\in \mathbb{N}$ tal que si $n,m\geq N$ tenemos que:
                \begin{equation*}
                    \|f_{\sigma(n)}(s) - f_{\sigma(m)}(s)\| < \frac{\varepsilon}{3} \qquad \forall s\in D_\delta
                \end{equation*}
                En definitiva, para $\varepsilon$ tomamos el $N$ recién encontrado y para cada $t\in I$ existirá $s\in D_{\delta}$ con $|t-s|<\delta$, de donde:
                \begin{multline*}
                    \|f_{\sigma(n)}(t) - f_{\sigma(n)}(s)\| \leq \|f_{\sigma(n)}(t) - f_{\sigma(n)}(s)\| + \|f_{\sigma(n)}(s) - f_{\sigma(m)}(s)\| \\ + \|f_{\sigma(m)}(s) - f_{\sigma(m)}(t)\| < \varepsilon
                \end{multline*}
        \end{enumerate}
    \end{proof}
\end{teo}
...
\noindent
Para ello, nuestra intención es aplicar el Teorema~\ref{teo:Arcoli-A}, por lo que buscamos probar que $\{x_{\varepsilon_n}\}$ es uniformemente acotada y equicontinua.\\
...
\noindent
En definitiva, aplicando el Teorema~\ref{teo:Arcoli-A} hemos encontrado una sucesión parcial $\{x_{\varepsilon_{\sigma(n)}}\}$ de sucesiones aproximadas que converge uniformemente. Esta sucesión tendrá un límite, al que llamaremos $x:\left]a,b\right[\to \mathbb{R}^d$, que sabemos que es continua, puesto que es límite uniforme de funciones continuas.\\
