...
\subsubsection{2 - Argumento de compacidad (Ascoli-Arzelá)}
\noindent
Abstrayendo el problema actual a un marco general, trabajaremos con un intervalo $I\subset \mathbb{R}$ y una sucesión de funciones $f_n:I\to \mathbb{R}^d$. Sea $f:I\to \mathbb{R}^d$, diremos que $f_n\to f$ converge uniformemente si:
\begin{equation*}
...
\begin{figure}[H]
    ...
    \draw (0,-0.5) -- (0,2.5);
    \draw (-0.5,0) -- (5,0);
    \fill (1,0) circle(2pt) node[] {};
    \fill (4,0) circle(2pt) node[] {};
...
\begin{ejemplo} % // TODO: reflexionar sobre este ejemplo
    Sea $f_n:[0,1]\to \mathbb{R}$ cuya gráfica es la de un triángulo de base $1/n$, altura $1$ y el resto $0$.\\
