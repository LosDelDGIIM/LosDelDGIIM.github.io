...
% // TODO: Reformular esto como teorema
\noindent
...
\begin{proof} % // TODO: No he entendido esta demo
    ...
    \noindent
    Una vez que ya sabemos que $\cc{D}$ es abierto, veaoms que $x:\cc{D}\to \mathbb{R}^d$ es continua. Para ello, usaremos la caracterización de la continuidad por sucesiones, tomaremos una sucesión $\{(\tau_n;t_{0n},x_{0n})\}$ dentro de $\cc{D}$ que converge a $(\tau;t_0,x_0)$ y queremos probar que entonces:
    \begin{equation*}
