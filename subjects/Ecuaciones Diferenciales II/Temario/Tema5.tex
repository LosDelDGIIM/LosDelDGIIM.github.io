...
% Esto es solo para el curso 25/26, próximos cursos depende del tiempo que tenga
    ...
    \noindent
    Para elevar $A = \lm I + N$ usaremos el binomio de Newton, que podemos usarlo puesto que la matriz identidad $I$ conmuta con cualquier otra. Vemos que $A\in \mathbb{R}^{r\times r}$ con $\lm\in \mathbb{C}$. Sabemos ya que $N^r = 0$. En primer lugar, debemos observar que no siempre se tiene que:
    \begin{equation*}
        e^{A+B} = e^Ae^B
    \end{equation*}
