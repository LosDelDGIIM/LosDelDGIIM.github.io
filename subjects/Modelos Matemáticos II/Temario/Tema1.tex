...
\noindent
De esta forma, tenemos que $F_{yy}, F_{yp}, F_{pp}$ son matrices de funciones.\\
...
\begin{prop}
    ...
    \begin{proof}
        ...
        \end{equation*}
        Para toda $\varphi \in C_0^1(I,\mathbb{R}^N)$. Usando el Lema fundamental del cálculo de variaciones para curvas (que anunciamos tras esta Proposición, salvo variaciones en hipótesis de la regularidad de $\varphi$), llegamos a la ecuación de Euler-Lagrage vectorial.
    \end{proof}
\end{prop}
