...
\begin{prop}
    Sea $X$ un espacio normado, sea $D\subset X$ convexo y $\cc{F}:D\to \mathbb{R}$ un funcional convexo, si $y_\ast\in D$ es un mínimo local entonces es un mínimo global.
    % // TODO: Se prueba mañana
\end{prop}
