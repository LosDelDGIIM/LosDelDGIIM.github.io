...
% - Ecuaciones de tipo Euler: coeficientes son potencias y el coeficiente que aparece es el orden de la derivada
%   Como en coef es el mismo orden, se hace siempre un mismo cambio de variable
