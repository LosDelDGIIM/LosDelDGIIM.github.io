...
\begin{ejercicio}
    ...
    \begin{equation*}
          \boxed{ \widehat{\frac{1}{\lambda^2}} = \widehat{\frac{1}{\lambda}}^2 = \left(\frac{\sum_l{i=1}^n X_i}{n}\right)^2 } 
    \end{equation*}
...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item Deducir dicho estimador a partir de los resultados del Ejercicio~\ref{ej:10_rel4}.
            ...
            \end{equation*}
            es eficiente para $\frac{1}{\theta}$, por lo que $T$ es el EMV de $\frac{1}{\theta}$. Si aplicamos el Teorema de Zehna, tenemos que:
            \begin{equation*}
...
\begin{ejercicio} % Se podría hacer también con una multinomial
