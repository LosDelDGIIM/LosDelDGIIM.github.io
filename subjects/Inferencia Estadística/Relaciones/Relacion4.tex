...
\begin{ejercicio}\label{ej:7_rel4}
    ...
    \end{equation*}
    En definitiva, $E[{(h(T))}^{2}] < \infty$, por lo que aplicando el Teorema de Lehmann-Scheffé, obtenemos que $E[h(T)/T] = h(T)$ es UMVUE. % // TODO: Falta hacer el UMVUE para e^theta
\end{ejercicio}
