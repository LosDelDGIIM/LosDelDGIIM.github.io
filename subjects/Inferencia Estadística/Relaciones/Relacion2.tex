...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        \item Probabilidad de que la cuasivarianza muestral esté comprendida entre $1.863$ y $2.674$.
            ...
            Tenemos una m.a.s. $(X_1, X_2, X_3, X_4, X_5)$, todas ellas idénticamente distribuidas a $X\rightsquigarrow \cc{N}(2.5,\ 3.6)$. Tomamos la cuasivarianza de dichos datos:
            \begin{equation*}
            ...
            \begin{equation*}
                \dfrac{(n-1)S^2}{\sigma^2}= \dfrac{4S^2}{3.6} \rightsquigarrow\chi^2(4) \equiv \chi^2(n-1)
            \end{equation*}
            Por tanto:
            \begin{align*}
                P[1.863 < S^2 < 2.674] &= P\left[\dfrac{4\cdot 1.863}{3.6}<\dfrac{4S^2}{3.6} < \dfrac{4\cdot 2.674}{3.6}\right] \\
                                       &= P\left[2.07 < \dfrac{4S^2}{3.6} < 2.971\right]  \\
                                       &= P\left[\dfrac{4S^2}{3.6} > 2.07\right] - P\left[\dfrac{4S^2}{3.6}>2.971\right]
            \end{align*}
            Si consultamos la tabla de la $\chi^2(4)$ (no encontramos los valores exactos, por lo que realizamos una media entre los dos más próximos):
            \begin{equation*}
                P\left[\dfrac{4S^2}{3.6} > 2.07\right] \approx 0.725, \qquad 
                P\left[\dfrac{4S^2}{3.6}>2.971\right] \approx 0.575
            \end{equation*}
            Por lo que:
            \begin{align*}
                P[1.863 < S^2 < 2.674] &= P\left[\dfrac{4S^2}{3.6} > 2.07\right] - P\left[\dfrac{4S^2}{3.6}>2.971\right] \approx 0.725 - 0.575  \\
                                       &= 0.15
            \end{align*}
        \item Probabilidad de que la media muestral esté comprendida entre $1.3$ y $3.5$, supuesto que la cuasivarianza muestral está entre $30$ y $40$. 
            ...
            En las situación del apartado anterior, ahora tenemos también en consideración la media muestral:
            \begin{equation*}
            ...
            \begin{align*}
                P[1.3<\overline{X}<3.5] &\stackrel{\text{tipificamos}}{=} P\left[\dfrac{\sqrt{5}(1.3-2.5)}{\sqrt{3.6}}< Z < \dfrac{\sqrt{5}(3.5-2.5)}{\sqrt{3.6}}\right] \\
                                        &= P[-1.4142 < Z < 1.1785] = P[Z<1.1785] - P[Z>1.4142] \\
                                        &= P[Z<1.1785] -1 + P[Z<1.4142] \\
                                        &= 0.881 - 1 + 0.92073 = 0.80173
            \end{align*}
    \end{enumerate}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \noindent
    Tenemos una población que sigue una variable aleatoria $X\rightsquigarrow \cc{N}\left(\mu, \sigma^2)$ con parámetros $\mu = 185.6$ y $\sigma=12.78$. Tomamos una m.a.s. $(X_1, \ldots, X_n)$ con $n=20$ y tomamos la media muestral:
    \begin{equation*}
