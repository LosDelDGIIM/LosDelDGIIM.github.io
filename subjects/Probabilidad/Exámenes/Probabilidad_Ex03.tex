...
\begin{document}
    ...
    \portadaExamen{ffccA4.jpg}{Probabilidad\\Examen III}{Probabilidad. Examen III}{MidnightBlue}{-8}{28}{2024-2025}{Arturo Olivares Martos \\ Miguel Ángel De la Vega Rodríguez}
...
\begin{ejercicio}[1.5 puntos]
    ...
    \begin{ejercicio}[5 puntos]
        ...
        \begin{enumerate}
            ...
            \begin{multline*}
                x^2=\dfrac{1-x}{2}\Rightarrow 2x^2+x-1=0\Longrightarrow x=\dfrac{-1\pm\sqrt{1+8}}{4}=\dfrac{-1\pm3}{4}\Longrightarrow
                \\ \Longrightarrow
                \left\{\begin{array}{l}
                    \cancel{x_1=-1}\\
                    x_2=\dfrac{1}{2}
