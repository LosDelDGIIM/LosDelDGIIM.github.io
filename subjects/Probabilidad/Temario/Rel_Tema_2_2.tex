...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        Definimos la transformación:
        \Func{g}{\bb{R}^+\times \bb{R}^+}{\bb{R}^+\times \bb{R}^+}{(X,Y)}{(Z,T)=(\nicefrac{X}{Y},XY)}
        ...
        \Func{g^{-1}}{\bb{R}^+\times \bb{R}^+}{\bb{R}^+\times \bb{R}^+}{(Z,T)}{(X,Y)=(\sqrt{ZT},\sqrt{\nicefrac{T}{Z}})}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                % Coloreamos (0,1) (1,1) (1,5) (0,5)
                \addplot[fill=orange, fill opacity=0.4, draw=none] coordinates {(0,1) (1,1) (1,5) (0,5)};

                % Señalizamos el punto (0,1) y el punto (a+b,1)
                \node[circle,fill,inner sep=1pt, label=above left:{$(0,1)$}] at (axis cs:0,1) {};
