        ...
        \begin{itemize}
            ...
            \begin{equation*}
                F_{\max(X,Y),\min(X,Y)}(z,t) = \begin{cases}
                    0 & z\leq 0 \lor t\leq 0\\
                    z^2 & z\leq t \land 0<z<1,\\
                    2zt-t^2 & 0<t<z<1, \\
                    2t-t^2 & 0<t<1\leq z,\\
                    1 & 1\leq t\land 1\leq z
                \end{cases}
            \end{equation*}
        \end{itemize}
...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        Sabiendo que $X,Y\geq 0$, tenemos que la situación es la siguiente:
        \begin{figure}[H]
            \centering
            \begin{tikzpicture}
                \begin{axis}[
...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        % // TODO: Distinto de Johhsoccas, comprobar
    \end{enumerate}
\end{ejercicio}
