...
\begin{observacion}
    Notemos que, para ver que una familia de variables aleatorias es reproductiva, usaremos el Corolario~\ref{coro:generatriz_momentos_independientes} para calcular la función generatriz de momentos de la variable aleatoria $X=\sum\limits_{i=1}^n X_i$.
\end{observacion}
