...
\begin{proof}
    ...
    \begin{align*}
        ...
        =\\&= \left[\left(\sum_{j=1}^k p_j e^{t_j}\right)+\left(1-\sum_{j=1}^k p_j\right)\right]^{\sum\limits_{i=1}^p n_i}
    \end{align*}
    Por tanto, la función generatriz de momentos de $\sum\limits_{i=1}^p X_i$ coincide con la de una distribución multinomial con los parámetros $\sum\limits_{i=1}^p n_i$ y las probabilidades asociadas a las componentes de $X_i$.
\end{proof}
