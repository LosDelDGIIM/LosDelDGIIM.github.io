...
\begin{ejercicio}
    ...
    Para calcular $E[\Var[Y\mid X]]$, tenemos que:
    \begin{align*}
        E[\Var[Y\mid X]] &= E\left[E[Y^2\mid X]-E[Y\mid X]^2\right]
        = E\left[E[Y^2\mid X]\right]-E\left[E[Y\mid X]^2\right]
        =\\&= E[Y^2]-E\left[E[Y\mid X]^2\right]
    \end{align*}

    Calculamos lo necesario:

    % // TODO: Calcular E[Var[Y|X]]
    \begin{comment}
    ...
    \begin{itemize}
        ...
        \item Si $x\in [1,2]$, tenemos que:
        \begin{align*}
            E[Y\mid X=x] &= \int_{0}^{1} y\cdot \dfrac{1}{2} \ dy
            = \dfrac{1}{2}\left[\dfrac{y^2}{2}\right]_{0}^{1}
            = \dfrac{1}{4}\\
            E[Y^2\mid X=x] &= \int_{0}^{1} y^2\cdot \dfrac{1}{2} \ dy
            = \dfrac{1}{2}\left[\dfrac{y^3}{3}\right]_{0}^{1}
            = \dfrac{1}{6}\\
            \Var[Y\mid X=x] &= E[Y^2\mid X=x]-E[Y\mid X=x]^2
            = \dfrac{1}{6}-\left(\dfrac{1}{4}\right)^2
            = \dfrac{5}{48}
        \end{align*}

        \item Si $x\in [2,3]$, tenemos que:
        \begin{align*}
            E[Y\mid X=x] &= \int_{x-2}^{1} y\cdot \dfrac{1}{3-x} \ dy
            = \dfrac{1}{3-x}\left[\dfrac{y^2}{2}\right]_{x-2}^{1}
            = \dfrac{1}{3-x}\left(\dfrac{1}{2}-\dfrac{(x-2)^2}{2}\right)
            =\\&= \dfrac{1}{3-x}\left(\dfrac{1}{2}-\dfrac{x^2-4x+4}{2}\right)
            = \dfrac{1}{3-x}\left(\dfrac{-x^2+4x-3}{2}\right)
            = \dfrac{-x^2+4x-3}{2(3-x)}\\
            E[Y^2\mid X=x] &= \int_{x-2}^{1} y^2\cdot \dfrac{1}{3-x} \ dy
            = \dfrac{1}{3-x}\left[\dfrac{y^3}{3}\right]_{x-2}^{1}
            = \dfrac{1}{3-x}\left(\dfrac{1}{3}-\dfrac{(x-2)^3}{3}\right)
            =\\&= \dfrac{1}{3-x}\left(\dfrac{1}{3}-\dfrac{x^3-6x^2+12x-8}{3}\right)
            = \dfrac{1}{3-x}\left(\dfrac{-x^3+6x^2-12x+9}{3}\right)
            =\\&= \dfrac{-x^3+6x^2-12x+9}{3(3-x)}\\
            \Var[Y\mid X=x] &= E[Y^2\mid X=x]-E[Y\mid X=x]^2
            =\\&= \dfrac{-x^3+6x^2-12x+9}{3(3-x)}-\left(\dfrac{-x^2+4x-3}{2(3-x)}\right)^2
        \end{align*}
    \end{itemize}

    Por tanto, tenemos que:
    \begin{align*}
        E[&\Var[Y\mid X]] = \int_0^1 \dfrac{x^2}{12}\cdot \dfrac{x}{2} \ dx + \int_1^2 \dfrac{5}{48}\cdot \dfrac{1}{2} \ dx +\\&\qquad + \int_2^3 \left(\dfrac{-x^3+6x^2-12x+9}{3(3-x)}-\left(\dfrac{-x^2+4x-3}{2(3-x)}\right)^2\right)\cdot \dfrac{3-x}{2} \ dx
        =\\&= \frac{1}{24}\left[\dfrac{x^4}{4}\right]_0^1 + \frac{5}{96}\left[x\right]_1^2 + \frac{1}{6}\int_2^3 \left(-x^3+6x^2-12x+9\right) \ dx - \frac{1}{4}\int_2^3 \dfrac{(-x^2+4x-3)^2}{(3-x)} \ dx
    \end{align*}

    Para resolver la última integral, tenemos que:
    \begin{equation*}
        (-x^2+4x-3)^2 = x^4-8x^3+22x^2-24x+9
    \end{equation*}

    Realizamos ahora la división de polinomios
    \polyset{style=C, div=:, vars=x}
    $$\polylongdiv{x^4-8x^3+22x^2-24x+9}{-x+3}$$

    Por tanto, tenemos que:
    \begin{align*}
        E[\Var[Y\mid X]] &= \frac{1}{24}\left[\dfrac{1}{4}\right] + \frac{5}{96} + \frac{1}{6}\int_2^3 \left(-x^3+6x^2-12x+9\right) \ dx -\\&\qquad - \frac{1}{4}\int_2^3 (-x^3+5x^2-7x+3) \ dx
        =\\&= \frac{1}{16}+\frac{1}{6}\left[-\dfrac{x^4}{4}+2x^3-6x^2+9x\right]_2^3 - \frac{1}{4}\left[-\dfrac{x^4}{4}+\dfrac{5x^3}{3}-\dfrac{7x^2}{2}+3x\right]_2^3
        =\\&= \frac{1}{16}+\frac{1}{6}\left[-\dfrac{3^4}{2^2}+\cancel{2\cdot 3^3}-\cancel{6\cdot 3^2}+3^3+2^2-2^4+6\cdot 2^2-9\cdot 2\right] -\\&\qquad - \frac{1}{4}\left[-\dfrac{3^4}{2^2}+5\cdot 3^2-\dfrac{7\cdot 3^2}{2}+3^2+2^2-\dfrac{5\cdot 2^3}{3}+7\cdot 2-3\cdot 2\right]
        =\\&= -\frac{1}{24}
    \end{align*}
    \end{comment}
\end{ejercicio}
