...
\begin{ejemplo}\
    \begin{enumerate}
        \item $\bb{S}^1$ es el recubridor universal de $\bb{R}$.
        \item $\bb{R}\bb{P}^n$ es el recubridor universal de $\bb{S}^n$ para $n\geq 2$
...
\begin{observacion}\
    \begin{enumerate}
        ...
        \item Si $U$ es un entorno de $b\in B$ tal que $(i_U)*: \pi_1(U,b) \to \pi_1(B,b)$ es trivial, entonces también es cierto que si $V$ es entorno de $b$ con $V\subseteq B$ se tiene que $(i_V)* : \pi_1(V,v)\to \pi_1(B,b)$ es trivial.
    \end{enumerate}
\end{observacion}
...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \begin{gather*}
            ...
            \right\}
        \end{gather*}
        Donde $S_n$ es una de las circunferencias del ejemplo anterior. Esto si se analiza gráficamente es fácil ver que son un montón de conos unidos con el origen y tangentes al $(0,0,1)$ y que intersecan con el plano de altura $1$ formando circunferencias tangentes al $(0,0,1)$ de la forma $S_n$.\\
