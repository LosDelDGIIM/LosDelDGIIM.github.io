...
\begin{ejemplo}\
    \begin{enumerate}
        ...
        \begin{align*}
            p_0\times p_0 : \bb{R}^2 &\to \bb{S}^1 \times \bb{S}^1\\
        ...
        \begin{align*}
            p_k\times p_0 : \bb{S}^1\times \bb{R} &\to \bb{S}^1 \times \bb{S}^1\\
        ...
        \begin{align*}
            p_0\times p_k : \bb{R}\times \bb{S}^1 &\to \bb{S}^1 \times \bb{S}^1\\
            (x,  \cos(\theta), \sen(\theta)) & \mapsto (\cos(2\pi x), \sen(2\pi x), cos(k\theta), \sen(k\theta))
        \end{align*}
        ...
        \begin{align*}
            p_k\times p_l : \bb{S}^1\times \bb{S}^1 &\to \bb{S}^1 \times \bb{S}^1\\
            (\cos(\theta), \sen(\theta), \cos(\varphi), \sen(\varphi)) & \mapsto (cos(k\theta), \sen(k\theta), \cos(l \varphi), \sen(l\varphi))
        \end{align*}
        Si estudiamos la imagen de los generadores tenemos 
        \begin{gather*}
            (p_k\times p_l)_*([\alpha]) = [\alpha]^k\\
            (p_k\times p_l)_*([\beta]) = [\beta]^k
        \end{gather*}
        ...
        Esto se ha hecho para el generador $(1,1)$ pero para cualquier generador $(a,b)\in \bb{Z}\times \bb{Z}$ se puede construir una aplicación $p'_{(a,b)}$ para cada $(a,b)\in \bb{Z}\times \bb{Z}$ de la siguiente forma:
        ...
        Por tanto tenemos que $(\bb{S}^1 \times \bb{R}, p'_{(a,b)})$ es recubridor del toro con subgrupo asociado $\{n(a,b) : n\in \bb{Z}\}$.\\
        ...
        \end{gather*}
        y tenemos que $(\bb{S}^1 \times \bb{S}^1, p'_{(a,b)}\times p'_{(c,d)})$ es recubridor del toro asociado al subgrupo $\{n_1(a,b) + n_2(c,d) : n_1,n_2\in \bb{Z}\}$.\\
