...
\begin{ejemplo}
    ...
    \begin{equation*}
        U=\left]-\frac{1}{2}, \frac{1}{2}\right[\times \left]-\frac{1}{2}, \frac{1}{2}\right[\cap X
    \end{equation*}

    Tenemos que $U$ es un abierto de $X$, y por ser $\alpha$ continua, $\alpha^{-1}(U)$ es un abierto de $[0,1]$ que contiene a $t_0$. Por tanto, existe un $\veps>0$ tal que $\alpha\left(\left]t_0-\veps, t_0+\veps\right[\cap [0,1]\right)\subseteq~U$. Elegimos $t_1\in \left]t_0, t_0+\veps\right[\cap [0,1]$ de forma que $\alpha(t_1)\neq (0,0)$, y por la elección de $t_0$ tenemos que $\alpha(t_1)\neq (0,0)$. Consideramos por tanto $\alpha(t_1) = (x_1, y_1)\in U$.\\
...
\begin{ejemplo}
    Veamos ahora otra forma de probar que $\bb{S}^n = \{x\in \bb{R}^{n+1} : |x| = 1\}$ es arcoconexo. Podemos hacerlo sabiendo que $\bb{S}^n\setminus \{N\}$, con $N=(0,\dots,0,1)$ es homeomorfo a $\bb{R}^n$ que es arcoconexo por lo que $\bb{S}^n \setminus\{N\}$ es arcoconexo. Análogamente, $\bb{S}^n \setminus\{S\}$ con $S=(0,\dots,0,-1)$ es arcoconexo y podemos escribir
    \begin{gather*}
