...
\begin{teo}
    ...
    \begin{enumerate}
        ...
        \item[(iii)]  $[\alpha]\ast \left[\tilde{\alpha}\right] = [\veps_x]$ y $\left[\tilde{\alpha}\right]\ast [\alpha] = [\veps_y]$
    \end{enumerate}
    \begin{proof}\
        \begin{enumerate}[label=(\roman*)]
            ...
            Usando el ejemplo~\ref{ej:homotopia_velocidad} de la página~\pageref{ej:homotopia_velocidad} se tiene que $[\alpha] \ast ([\beta] \ast [\gamma]) = ([\alpha] \ast [\beta]) \ast [\gamma]$ (realmente se están recorriendo las mismas curvas pero a distinta velocidad).


            \item Tendremos que ver que $\alpha \ast \veps_y$ se relaciona por una homotopía con arcos con $\alpha$. Recordemos que
            \begin{gather*}
            ...
            \item Tendremos que ver en este caso que $\displaystyle \alpha\ast\tilde{\alpha}$ es homotópico por arcos a $\veps_x$. Describamos ambas curvas.
            \begin{gather*}
