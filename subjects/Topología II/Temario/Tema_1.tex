...
\begin{ejemplo}\
    \begin{enumerate}
        \item $X=\bb{S}^1 \cup (\bb{R}\times\{1\})$. Veamos que $\bb{S}^1$ es retracto de deformación de $X$. Para ello buscamos $H:X\times[0,1]\to X$ y la definimos de la siguiente forma:
        \begin{gather*}
            H(x,t) = \left\{
                \begin{array}{l c c }
        ...
        \item $X=(\bb{R}\times \{-1,1\})\cup (\{-1,1\}\times \bb{R})$. Veamos que $A=([-1,1]\times \{-1,1\})\cup (\{-1,1\}\times [-1,1])$ es un retracto de deformación de $X$. Para ello definimos la homotopía como 
        \begin{gather*}
            H(x,t) = \left\{
...
\begin{ejemplo}\
    \begin{gather*}
        ...
        [\alpha]_X \leftarrow [\alpha]_{\bb{S}^1}
    \end{gather*}
\end{ejemplo}
