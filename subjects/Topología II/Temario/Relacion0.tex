    ...
    \begin{itemize}
        ...
        \item Si $p_1 = (0,0)$ y $p_2 = (0,1)$, entonces si tomamos $\gamma:[0,1]\to X$ dada por:
            \begin{equation*}
                ...
                \end{array}\right.
            \end{equation*}
            Tenemos que $\gamma$ es continua, ya que, si $B = \left]a,b\right[\times \{0,1\}\in \cc{B}$, se tiene:
            \begin{equation*}
            ...
            Notemos que la elección del punto $(0,0)$ y $(0,1)$ es arbitraria. Bastaría con tomar $p_1=(x,0)$ y $p_2 = (x,1)$.
