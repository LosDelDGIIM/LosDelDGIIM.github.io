...
\begin{ejemplo}
    Consideramos la presentación $\cc{P} = \{a,b,c\ ; a^{-1}cb,\ ac^{-1}b^{-1}\}$. Veamos qué superficie $|\cc{P}|$ tiene asociada. De la presentación podemos obtener los triángulos $w_1=a^{-1}cb$ y $w_2=ac^{-1b^{-1}}$.
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
            \shorthandoff{>}
