...
\ \\
Podemos concluir el estudio de una superficie $\cc{P}$ con la siguiente tabla:
\begin{center}
    ...
    \begin{tabular}{|l | c | c |}
        ...
        $\chi(\cc{P})\leq 0$ par & $\bb{T}_n$ con $n=1-\frac{\chi}{2}$ & $\bb{R}\bb{P}^2_n$ con $n=2-\chi$\\
        $\chi(\cc{P})<0$ impar & - & $\bb{R}\bb{P}^2_n$ con $n=2-\chi$\\
        \hline
    \end{tabular}
\end{center}
