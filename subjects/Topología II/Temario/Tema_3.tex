...
\begin{prop}
    ...
    \begin{gather*}
        \cc{P}_1=\{a_1,...,a_n;w_1\}\ \ \text{ y } \ \ \cc{P}_2=\{b_1,...,b_k;w_2\}
    \end{gather*}
...
\begin{observacion}
    ...
    \begin{gather*}
        \begin{array}{r c  l}
            ...
            aa^{-1}bb \text{ es una presentación de } \bb{R}\bb{P}^2 & \Rightarrow & \bb{R}\bb{P}^2 \text{ es no orientable}\\
            a_1b_1a_1^{-1}b_1^{-1}...a_nb_na_n^{-1}b_n^{-1} \text{ es una presentación de } \bb{T}_n & \Rightarrow & \bb{T}_n \text{ es orientable ($n\geq 1$)}\\
            a_1a_1...a_na_n \text{ es una presentación de } \bb{R}\bb{P}_n^2  & \Rightarrow & \bb{R}\bb{P}_n^2 \text{ es no orientable ($n\geq 2$)}
        \end{array}
    \end{gather*}
...
\ \\
Podemos concluir el estudio de una superficie $S$ con presentación poligonal $\cc{P}$, es decir, $S=|\cc{P}|$, con la siguiente tabla:
\begin{center}
    \renewcommand{\arraystretch}{1.25} % Dobla el espacio vertical
    \begin{tabular}{|l | c | c |}
        \hline
        & Orientable & No orientable\\
        \hline
        $\chi(\cc{P}) =  2$ & $\bb{S}^2$ & -\\
        $\chi(\cc{P}) = 1$ & - & $\bb{R}\bb{P}^2$\\
        $\chi(\cc{P})\leq 0$ par & $\bb{T}_n$ con $n=1-\frac{\chi(\cc{P})}{2}$ & $\bb{R}\bb{P}^2_n$ con $n=2-\chi(\cc{P})$\\
        $\chi(\cc{P})<0$ impar & - & $\bb{R}\bb{P}^2_n$ con $n=2-\chi(\cc{P})$\\
        \hline
    \end{tabular}
\end{center}
