...
\begin{ejercicio}\label{ej:11_rel3}
    ...
    \begin{description}
        \item [$\Longleftarrow )$] Como $\pi$ es una proyección al cociente tenemos ya que es continua y sobreyectiva. Sea ahora $\xi \in X/\cc{R}_G$, tenemos que existe $x\in X$ con $\xi = \pi(x)$. Para $x$ tenemos que existe un entorno $U_x$ de forma que $\varphi(U_x)\cap U_x=\emptyset $. Como $U_x$ es entorno de $x$ ha de existir un abierto $O_x$ de forma que $x\in O_x\subseteq U_x$. Si consideramos ahora:
            ...
            \end{equation*}
            Tenemos que $A$ es abierto, como unión de conjuntos abiertos, así como $\pi-$saturado, pues si $y\in X$ cumple que $y\cc{R}_G z$ para $z\in A$ tenemos entonces que $\exists \varphi \in G$ con:
            \begin{equation*}
                y = \varphi(z)
            \end{equation*}
