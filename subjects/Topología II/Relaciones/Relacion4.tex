...
\begin{ejercicio}
    ...
    \begin{itemize}
        ...
        \item Para $\mathbb{T}_n\# \mathbb{R}\mathbb{P}^2$ sabemos por el Ejercicio~\ref{ej:orientabilidad} que debe ser una superficie no orientable, luego ha de ser homeomorfa a $\mathbb{R}\mathbb{P}^2_n$ para $n\geq 1$. Estudiemos su característica de Euler usando para ello el Ejercicio~\ref{ej:suma_chi}:
            \begin{equation*}
...
\begin{ejercicio}
    ...
    \begin{description}
        ...
        \item [$\Longrightarrow )$] Si $\chi(S)\geq -2$, podemos asumir que tenemos una presentación poligonal $\cc{P}$ de $S$ con una sola cara y un solo vértice, gracias al algoritmo de clasificación de superficies compactas. En este punto, tendremos que:
            ...
            \end{equation*}
            Por lo que la presentación poligonal $\cc{P}$ tiene menos de 4 aristas.
            \begin{itemize}
...
\begin{ejercicio}
    ...
    \end{equation*}
    con los tres primeros conmutativos y el último no, que de hecho tiene grupo abelianizador:
    \begin{equation*}
...
\begin{ejercicio}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item $\mathbb{R}\bb{P}^2_4$.
            Para este caso tenemos que dos letras tienen que tener el mismo exponente (puesto que buscamos una presentación poligonal no onrientable de una ola expresión), por lo que las combinaciones son:
            \begin{itemize}
                \item $d$, $e$.
                \item $d$, $e^{-1}$.
                \item $d^{-1}$, $e$.
