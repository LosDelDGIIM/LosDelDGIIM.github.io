    ...
    \begin{ejercicio}
        ...
        \begin{itemize}
            ...
            \item $U$ tiene como retracto de deformación el conjunto $Z = S_2\cup [(1,0,0), (3,0,0)]$:
                ...
                Si en este tomamos:
                \begin{equation*}
                    W = Z\setminus \{(2,0,0)\}, \qquad K = Z\setminus \{(2,0,1)\}
                \end{equation*}
                Tenemos:
                \begin{itemize}
                    ...
                    \item $W\cap K$ tiene a $S_2\setminus \{(2,0,1)\}$ como retracto de deformación, que es homeomorfo a $\mathbb{R}^2$, por lo que $W\cap K$ es simplemente conexo.
