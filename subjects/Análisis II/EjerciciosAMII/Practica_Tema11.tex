...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        Sea ahora $G:\left]\nicefrac{\pi}{4},\nicefrac{\pi}{2}\right[\to J$ dada por $G(x)=-\dfrac{1}{\sen x}$ para todo $x\in \left]\nicefrac{\pi}{4},\nicefrac{\pi}{2}\right[$.
        Tenemos que $G$ es derivable, con $G'=(f\circ \varphi)\varphi'$, por lo que es una primitiva suya. Tenemos que:
        \begin{equation*}
            \lim_{x\to \frac{\pi}{4}} G = -\frac{1}{\sen\left(\nicefrac{\pi}{4}\right)} = -\sqrt{2}
            \hspace{1cm}
            \lim_{x\to \frac{\pi}{4}} G = -\frac{1}{\sen\left(\nicefrac{\pi}{2}\right)} = -1
        \end{equation*}

        Por el Criterio de Integrabilidad de la Regla de Barrow, tenemos que 
