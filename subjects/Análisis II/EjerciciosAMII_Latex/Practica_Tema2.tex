...
\begin{ejercicio}
    ...
    \begin{enumerate}
        ...
        \end{equation*}
        Como la serie $\sum\limits_{n\geq 1}\dfrac{1}{n^\rho}$ es convergente $\left(\rho > 1\right)$, por el Test de Weierstrass, la serie $\sum\limits_{n\geq 1}g_n$ converge uniformemente en $[\rho, +\infty[$.
...
\begin{ejercicio}
    ...
    \begin{itemize}
        ...
        % // TODO: Por qué aquí quita el abs. Ejemplo serie de potencias
        ...
        % // TODO: Convergencia uniforme en J serie de potencias
    \end{itemize}
\end{ejercicio}
...
\begin{ejercicio}
    ...
    % // TODO: Probar la NO convergencia uniforme
\end{ejercicio}
