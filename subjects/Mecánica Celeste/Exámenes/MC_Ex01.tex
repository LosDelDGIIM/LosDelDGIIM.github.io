...
\begin{document}
    ...
    \begin{itemize}
        ...
        donde $\mu = GM = 1$ por el enunciado. Como $a$ está dado en kilómetros, el periodo vendrá expresado en segundos y 

        $$p = \dfrac{2 \pi}{\sqrt{1}} (10^3)^{3/2} \approx 198692 \text{ s} \approx 3312 \text{ m} \approx
        55 \text{ h} \approx 2,3 \text{ días}$$

        \boxed{\text{Así, el planeta tarda aproximadamente 2,3 días en dar una vuelta completa a su órbita.}}
    ...
    Ya podemos terminar el ejercicio, sin más que sustituir correctamente

    \begin{enumerate}
            \item $Q_1$. Se corresponde con el periastro, cuya distancia ya sabemos que es $800$ kilómetros. Por tanto, la velocidad será 
            $$\dot{x}(t_1) = \sqrt{\left( \dfrac{2}{800} - \dfrac{1}{10^3} \right)} \approx 0,00387 \text{ km/s} \approx 38,7 \text{ m/s}$$
            \item $Q_2$ y $Q_4$. La distancia de ambos puntos de la trayectoria elíptica al planeta es $d$, luego 
            $$\dot{x}(t_2) = \dot{x}(t_4) = \sqrt{\left( \dfrac{2}{d} - \dfrac{1}{10^3} \right)} \approx 0,0313 \text{ km/s} \approx 31,3 \text{ m/s}$$
            \item $Q_3$. Se corresponde con el apoastro, cuya distancia ya sabemos que es $1200$ kilómetros. Por tanto, la velocidad será 
            $$\dot{x}(t_3) = \sqrt{\left( \dfrac{2}{1200} - \dfrac{1}{10^3} \right)} \approx 0,0258 \text{ km/s} \approx 25,8 \text{ m/s}$$
        \end{enumerate}
    \end{ejercicio}
