...
\begin{ejercicio}\label{ej:1.3.7}
    ...
    \begin{itemize}
        \item Palabras en las que el número de 1 es múltiplo de 3 y el número de 0 es par.
        \item $\{{(01)}^{2i} \mid i \geq 0\}$
        \item $\{(0^{2i}1^{2i}) \mid i \geq 0\}$
    \end{itemize}
\end{ejercicio}
...
\begin{ejercicio}\label{ej:1.3.8}
    ...
    \begin{itemize}
        ...
        \item $q_{10}q_{20}$ y $q_{10}q_{21}$ son indistinguibles, ya que leyendo $10$:
        \begin{equation*}
...
\begin{ejercicio}\label{ej:1.3.12}
    ...
    \end{align*}
    \begin{itemize}
        \item Escribe el diagrama de transiciones para el AFD que acepte el lenguaje $L(G)$ generado por $G$.
        \item Encuentra una gramática regular por la izquierda que genere ese mismo lenguaje $L(G)$.
        \item Encuentra el AFD que acepte el complementario del lenguaje $L(G)$.
    \end{itemize}
\end{ejercicio}
