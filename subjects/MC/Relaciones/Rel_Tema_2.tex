...
\begin{ejercicio} \label{ej:1.2.19}
    ...
    % // TODO: Hecho en clase. Comparar con gente
    La expresión regular es:
    \begin{align*}
        (0+1)^*110.
    \end{align*}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw   (q0) edge[below] node{1} (q1)
                    ...
                    (q1) edge[above, bend right] node[pos=0.1]{0} (q0)
...
\begin{ejercicio}
    ...
    % // TODO: Hecho por Irina, preguntar
\end{ejercicio}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw   (q0) edge[below] node{0} (q1)
                    ...
                    (q1) edge[above, bend right] node[pos=0.1]{1} (q0)
