...
\begin{ejercicio}
    ...
    $L^{\ast}$ es siempre numerable: $L^{\ast}$ es un lenguaje del alfabeto $A$, por lo que $L^{\ast}\subseteq A^{\ast}$ y $A^{\ast}$ es numerable, luego $L^{\ast}$ también lo es.
\end{ejercicio}
...
\begin{ejercicio}
    ...
    \begin{equation*}
        L = L^{\ast} \Longleftrightarrow \veps \in L \land a,b \in L \Longrightarrow ab\in L
    \end{equation*}
    ...
    \begin{proof}\ 
        \begin{description}
            \item [$\Longleftarrow)$] La inclusión $L\subseteq L^{\ast}$ es obvia, por lo que solo falta demostrar la otra inclusión.\\
                ...
                Sea $v\in L^{\ast}$:
                \begin{enumerate}
                    \item Si $v = \veps \Longrightarrow v\in L$.
                    \item Si no, $\exists n\in \mathbb{N}$ tal que 
                        \begin{equation*}
                            v = a_1 a_2 \ldots a_n
                        \end{equation*}
            ...
            \item [$\Longrightarrow)$] Hemos de probar dos cosas:
                \begin{enumerate}
                    ...
                    \item Sean $a,b\in L=L^{\ast} \Longrightarrow ab\in L^{\ast}=L$.
                \end{enumerate}
        \end{description}
    \end{proof}
\end{ejercicio}
...
\begin{ejercicio}[Complejidad: Sencilla]
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            ...
            P &= \left\{
                \begin{array}{rcl}
                    S &\rightarrow & aSa \mid bSb \mid \veps
                \end{array}
            \right\}
        \end{align*}
    \end{enumerate}
