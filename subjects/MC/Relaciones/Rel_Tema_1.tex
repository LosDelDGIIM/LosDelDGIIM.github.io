...
\begin{ejercicio}[Complejidad: Difícil] \label{ej:1.1.17}
    Calcula, de forma razonada, gramáticas que generen cada uno de los siguientes lenguajes:
    \begin{enumerate}
        ...
        \item \label{ej:1.1.17.b}
        Palabras que son múltiplos de 7 en binario.
            \begin{description}
                \item [Opción 1.] 
