...
\begin{ejercicio}\label{ej:1.4.13}
    ...
    \begin{enumerate}
        ...
        \end{equation*}
        Por tanto, llegamos a una contradicción, por lo que $L_1$ no es regular. Veamos que es independiente del contexto. Para esto, construimos % // TODO: Hecho por Irina.
        % Idea: Partir en subconjuntos disjuntos
...
\begin{ejercicio}\label{ej:1.4.16}
    ...
    \begin{enumerate}
        ...
        \begin{equation*}
            ...
            \end{aligned}
        \end{equation*}
        % // TODO: Hecho por Irina. Completar
