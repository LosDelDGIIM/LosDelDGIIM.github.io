...
\begin{ejercicio}\label{ej:1.4.7}
    ...
    \begin{enumerate}
        ...
        \begin{equation*}
            ...
            \end{aligned}
        \end{equation*}
        donde notemos que hemos forzado a que $i,j,k\in \bb{N}\setminus \{0\}$ (algo que depende de la interpretación del enunciado).
...
\begin{ejercicio}\label{ej:1.4.22}
    ...
    \begin{enumerate}
        ...
        \begin{figure}
            ...
            \end{subfigure}
            \caption{Árboles de derivación para la palabra \texttt{if condicion then if condicion then a := 1 else a := 1}.}
            \label{fig:1.4.22}
        \end{figure}
