    ...
    \begin{enumerate}
        ...
        \begin{figure}
            ...
            \begin{tikzpicture}
                ...
                \node[state, accepting] (q1p0) [right of=q0p0] {$q_1p_0$};
                \node[state, accepting] (q0p2) [right of=q1p0] {$q_0p_2$};
                \node[state] (q1p2) [below of=q0p0] {$q_1p_2$};
                \node[state] (q1p1) [right of=q1p2] {$q_1p_1$};
                \node[state, accepting] (q0p1) [right of=q1p1] {$q_0p_1$};


                \draw   (q0p0) edge[above] node{$a$} (q1p1)
                        (q0p1) edge[above] node{$a$} (q1p2)
                        (q0p2) edge[above] node{$a$} (q1p0)
                        (q1p0) edge[above] node{$a$} (q0p1)
                        (q1p1) edge[above] node{$a$} (q0p2)
                        (q1p2) edge[above] node{$a$} (q0p0);
            \end{tikzpicture}
